# QA Test Plan: Stormbinder Wand

Generated: 2025-12-27T13:29:56.074Z
...
3. Place `stormbinderwand.jar` in mods folder
4. Launch Minecraft
...
|------|-------------|---------|--------|---------------|
| Lightning Wand | `/give @p stormbinderwand:lightning_wand` | ☐ | ☐ | ☐ |
