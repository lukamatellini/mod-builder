package com.modgen.abyssalascent.client.model;
...
public class VoidKingModel extends EntityModel<VoidKingBossEntity> {
    ...
    @Override
    public void setAngles(VoidKingBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
