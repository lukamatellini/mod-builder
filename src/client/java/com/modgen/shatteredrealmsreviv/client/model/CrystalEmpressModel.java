package com.modgen.shatteredrealmsreviv.client.model;
...
/**
 * Entity model for Crystal Empress
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CrystalEmpressModel extends EntityModel<CrystalEmpressBossEntity> {
    ...
    public CrystalEmpressModel(ModelPart root) {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("right_arm", ModelPartBuilder.create()
            ...
            ModelTransform.pivot(-5.0F, 3.0F, 0.0F));
        ...
        modelPartData.addChild("right_leg", ModelPartBuilder.create()
            ...
            ModelTransform.pivot(-1.9F, 18.0F, 0.0F));
    ...
    @Override
    public void setAngles(CrystalEmpressBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
