...
/**
 * Entity model for Sumo Wrestler
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class SumoWrestlerModel extends EntityModel<SumoWrestlerEntity> {
    ...
    public SumoWrestlerModel(ModelPart root) {
    ...
    @Override
    public void setAngles(SumoWrestlerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
