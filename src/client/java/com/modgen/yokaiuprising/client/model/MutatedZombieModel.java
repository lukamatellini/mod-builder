package com.modgen.yokaiuprising.client.model;
...
/**
 * Entity model for Mutated Zombie
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class MutatedZombieModel extends EntityModel<MutatedZombieEntity> {
    ...
    public MutatedZombieModel(ModelPart root) {
    ...
    @Override
    public void setAngles(MutatedZombieEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
