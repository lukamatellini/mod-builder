...
/**
 * Entity model for Cave Worm
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CaveWormModel extends EntityModel<CaveWormEntity> {
    ...
    public CaveWormModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CaveWormEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
