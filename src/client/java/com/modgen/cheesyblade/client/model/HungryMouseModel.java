...
/**
 * Entity model for Hungry Mouse
 * Body type: quadruped
 */
@Environment(EnvType.CLIENT)
public class HungryMouseModel extends EntityModel<HungryMouseEntity> {
    ...
    public HungryMouseModel(ModelPart root) {
    ...
    @Override
    public void setAngles(HungryMouseEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
