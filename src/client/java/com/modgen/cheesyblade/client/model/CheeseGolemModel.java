package com.modgen.cheesyblade.client.model;
...
/**
 * Entity model for Cheese Golem
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CheeseGolemModel extends EntityModel<CheeseGolemEntity> {
    ...
    public CheeseGolemModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CheeseGolemEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
