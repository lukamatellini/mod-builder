...
public class ShatteredRealmSkyRenderer {
    ...
    private static final Identifier SKY_TEXTURE = Identifier.of("epicadventure", "textures/environment/shattered_realm_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("epicadventure", "textures/environment/shattered_realm_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("epicadventure", "textures/environment/shattered_realm_moon.png");
