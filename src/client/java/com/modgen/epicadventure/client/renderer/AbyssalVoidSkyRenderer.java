...
public class AbyssalVoidSkyRenderer {
    ...
    private static final Identifier SKY_TEXTURE = Identifier.of("epicadventure", "textures/environment/abyssal_void_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("epicadventure", "textures/environment/abyssal_void_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("epicadventure", "textures/environment/abyssal_void_moon.png");
