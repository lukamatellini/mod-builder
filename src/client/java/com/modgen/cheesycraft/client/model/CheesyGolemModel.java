...
/**
 * Entity model for Cheesy Golem
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CheesyGolemModel extends EntityModel<CheesyGolemEntity> {
    ...
    public CheesyGolemModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CheesyGolemEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
