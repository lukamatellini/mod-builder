...
/**
 * Entity model for Abyssal Lurker
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class AbyssalLurkerModel extends EntityModel<AbyssalLurkerEntity> {
    ...
    @Override
    public void setAngles(AbyssalLurkerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
