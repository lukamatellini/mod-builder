...
/**
 * Entity model for Corrupted Villager
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CorruptedVillagerModel extends EntityModel<CorruptedVillagerEntity> {
    ...
    public CorruptedVillagerModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CorruptedVillagerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
