...
/**
 * Entity model for Void Crawler
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class VoidCrawlerModel extends EntityModel<VoidCrawlerEntity> {
    ...
    @Override
    public void setAngles(VoidCrawlerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
