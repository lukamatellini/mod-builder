...
/**
 * Entity model for Void Commander
 * Body type: flying
 */
@Environment(EnvType.CLIENT)
public class VoidCommanderModel extends EntityModel<VoidCommanderEntity> {
    private final ModelPart head;
    private final ModelPart body;
    private final ModelPart rightWing;
    private final ModelPart leftWing;
    
    public VoidCommanderModel(ModelPart root) {
    ...
    @Override
    public void setAngles(VoidCommanderEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
