package com.modgen.abyssawakensisanepic.client.model;
...
/**
 * Entity model for The Void King
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class TheVoidKingModel extends EntityModel<TheVoidKingBossEntity> {
    ...
    public TheVoidKingModel(ModelPart root) {
    ...
    @Override
    public void setAngles(TheVoidKingBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
