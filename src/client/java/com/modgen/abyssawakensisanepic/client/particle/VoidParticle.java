...
/**
 * Void Particle
 * Custom particle effect for void-type abilities
 */
...
public class VoidParticle extends SpriteBillboardParticle {
    ...
    protected VoidParticle(ClientWorld world, double x, double y, double z, 
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world,
                                       ...
                                       double velocityX, double velocityY, double velocityZ) {
            return new VoidParticle(world, x, y, z, velocityX, velocityY, velocityZ, this.spriteProvider);
        }
    }
}