...
/**
 * Custom sky renderer for the The Abyssal Void dimension
 * Renders themed sky, sun, moon, and atmospheric effects
 * MC 1.21.1 COMPATIBLE - Uses GameRenderer shader methods
 */
public class AbyssalVoidSkyRenderer {
    
    private static final Identifier SKY_TEXTURE = Identifier.of("abyssawakensisanepic", "textures/environment/abyssal_void_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("abyssawakensisanepic", "textures/environment/abyssal_void_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("abyssawakensisanepic", "textures/environment/abyssal_void_moon.png");
    
    // Theme colors (RGB 0-1)
    private static final float SKY_R = 0.020f;
    private static final float SKY_G = 0.000f;
    private static final float SKY_B = 0.059f;
    
    private static final float HORIZON_R = 0.078f;
    private static final float HORIZON_G = 0.039f;
    private static final float HORIZON_B = 0.157f;
    
    private static final float FOG_R = 0.157f;
    private static final float FOG_G = 0.078f;
    private static final float FOG_B = 0.235f;
    ...
    /**
     * Render sun and moon
     * Uses GameRenderer::getPositionTexProgram for MC 1.21.1 compatibility
     */
    private static void renderCelestialBodies(MatrixStack matrices, Matrix4f projectionMatrix, float timeOfDay, float tickDelta) {
        ...
        // Render sun - MC 1.21.1: Use GameRenderer::getPositionTexProgram
        ...
        // Render moon (opposite side) - MC 1.21.1: Use GameRenderer::getPositionTexProgram
