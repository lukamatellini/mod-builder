...
/**
 * HUD Overlay System for Magic Wand
...
public class ModHudOverlay implements HudRenderCallback {
    private static final Logger LOGGER = LoggerFactory.getLogger("magicwand/hud");
    ...
    private static final Identifier HUD_ICONS = Identifier.of("magicwand", "textures/gui/hud_icons.png");
