...
public class NPCRenderer extends MobEntityRenderer<ModGenNPCEntity, NPCModel> {
    private static final Identifier DEFAULT_TEXTURE = Identifier.of("shatteredascent", "textures/entity/npc_default.png");
    ...
    public Identifier getTexture(ModGenNPCEntity entity) {
        ...
        if (npcId != null && !npcId.isEmpty()) {
            return Identifier.of("shatteredascent", "textures/entity/npc_" + npcId + ".png");
        }
