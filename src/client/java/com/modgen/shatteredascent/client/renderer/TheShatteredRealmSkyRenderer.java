...
/**
 * Custom sky renderer for the The Shattered Realm dimension
 * Renders themed sky, sun, moon, and atmospheric effects
 * MC 1.21.1 COMPATIBLE - Uses GameRenderer shader methods
 */
public class TheShatteredRealmSkyRenderer {
    
    private static final Identifier SKY_TEXTURE = Identifier.of("shatteredascent", "textures/environment/the_shattered_realm_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("shatteredascent", "textures/environment/the_shattered_realm_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("shatteredascent", "textures/environment/the_shattered_realm_moon.png");
