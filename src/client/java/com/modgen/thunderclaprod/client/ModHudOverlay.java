...
/**
 * HUD Overlay System for Thunderclap Rod
...
public class ModHudOverlay implements HudRenderCallback {
    private static final Logger LOGGER = LoggerFactory.getLogger("thunderclaprod/hud");
    ...
    private static final Identifier HUD_ICONS = Identifier.of("thunderclaprod", "textures/gui/hud_icons.png");
