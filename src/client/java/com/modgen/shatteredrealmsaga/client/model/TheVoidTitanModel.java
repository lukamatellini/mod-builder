package com.modgen.shatteredrealmsaga.client.model;
...
/**
 * Entity model for The Void Titan
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class TheVoidTitanModel extends EntityModel<TheVoidTitanBossEntity> {
    ...
    public TheVoidTitanModel(ModelPart root) {
    ...
    @Override
    public void setAngles(TheVoidTitanBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
