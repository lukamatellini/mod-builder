...
public class TheShatteredRealmSkyRenderer {
    ...
    private static final Identifier SKY_TEXTURE = Identifier.of("shatteredrealmsaga", "textures/environment/the_shattered_realm_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("shatteredrealmsaga", "textures/environment/the_shattered_realm_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("shatteredrealmsaga", "textures/environment/the_shattered_realm_moon.png");
