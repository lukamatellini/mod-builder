package com.modgen.chancecubes.client.model;
...
/**
 * Entity model for Unlucky Zombie
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class UnluckyZombieModel extends EntityModel<UnluckyZombieEntity> {
    ...
    public UnluckyZombieModel(ModelPart root) {
    ...
    @Override
    public void setAngles(UnluckyZombieEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
