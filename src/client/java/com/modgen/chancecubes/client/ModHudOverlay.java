...
/**
 * HUD Overlay System for Chance Cubes
...
public class ModHudOverlay implements HudRenderCallback {
    private static final Logger LOGGER = LoggerFactory.getLogger("chancecubes/hud");
    ...
    private static final Identifier HUD_ICONS = Identifier.of("chancecubes", "textures/gui/hud_icons.png");
