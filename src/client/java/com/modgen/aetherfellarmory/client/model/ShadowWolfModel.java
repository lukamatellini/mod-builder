...
/**
 * Entity model for Shadow Wolf
 * Body type: quadruped
 */
@Environment(EnvType.CLIENT)
public class ShadowWolfModel extends EntityModel<ShadowWolfEntity> {
    ...
    public ShadowWolfModel(ModelPart root) {
    ...
    @Override
    public void setAngles(ShadowWolfEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
