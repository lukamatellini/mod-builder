package com.modgen.aetherfellarmory.client.model;
...
/**
 * Entity model for Ancient Dragon Boss
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class AncientDragonBossModel extends EntityModel<AncientDragonBossBossEntity> {
    ...
    public AncientDragonBossModel(ModelPart root) {
    ...
    @Override
    public void setAngles(AncientDragonBossBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
