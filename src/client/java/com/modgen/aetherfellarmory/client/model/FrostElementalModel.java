...
/**
 * Entity model for Frost Elemental
 * Body type: flying
 */
@Environment(EnvType.CLIENT)
public class FrostElementalModel extends EntityModel<FrostElementalEntity> {
    ...
    @Override
    public void setAngles(FrostElementalEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
