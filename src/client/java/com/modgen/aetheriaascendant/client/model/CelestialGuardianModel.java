package com.modgen.aetheriaascendant.client.model;
...
/**
 * Entity model for Celestial Guardian
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CelestialGuardianModel extends EntityModel<CelestialGuardianBossEntity> {
    ...
    public CelestialGuardianModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CelestialGuardianBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
