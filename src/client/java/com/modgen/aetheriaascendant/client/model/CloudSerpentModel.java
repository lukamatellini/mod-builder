...
/**
 * Entity model for Cloud Serpent
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CloudSerpentModel extends EntityModel<CloudSerpentEntity> {
    ...
    public CloudSerpentModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CloudSerpentEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
