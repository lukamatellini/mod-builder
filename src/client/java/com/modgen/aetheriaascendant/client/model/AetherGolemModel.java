...
/**
 * Entity model for Aether Golem
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class AetherGolemModel extends EntityModel<AetherGolemEntity> {
    ...
    public AetherGolemModel(ModelPart root) {
    ...
    @Override
    public void setAngles(AetherGolemEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
