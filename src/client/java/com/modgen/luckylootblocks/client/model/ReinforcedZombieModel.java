...
/**
 * Entity model for Reinforced Zombie
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class ReinforcedZombieModel extends EntityModel<ReinforcedZombieEntity> {
    ...
    public ReinforcedZombieModel(ModelPart root) {
    ...
    @Override
    public void setAngles(ReinforcedZombieEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
