...
/**
 * Entity model for Lucky Spider
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class LuckySpiderModel extends EntityModel<LuckySpiderEntity> {
    ...
    public LuckySpiderModel(ModelPart root) {
    ...
    @Override
    public void setAngles(LuckySpiderEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
