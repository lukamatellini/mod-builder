...
/**
 * Entity model for Lucky Zombie
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class LuckyZombieModel extends EntityModel<LuckyZombieEntity> {
    ...
    public LuckyZombieModel(ModelPart root) {
    ...
    @Override
    public void setAngles(LuckyZombieEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
