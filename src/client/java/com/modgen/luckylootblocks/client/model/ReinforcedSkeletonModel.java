package com.modgen.luckylootblocks.client.model;
...
/**
 * Entity model for Reinforced Skeleton
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class ReinforcedSkeletonModel extends EntityModel<ReinforcedSkeletonEntity> {
    ...
    public ReinforcedSkeletonModel(ModelPart root) {
    ...
    @Override
    public void setAngles(ReinforcedSkeletonEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
