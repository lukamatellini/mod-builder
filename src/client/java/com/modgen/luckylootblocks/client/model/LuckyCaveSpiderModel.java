...
/**
 * Entity model for Lucky Cave Spider
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class LuckyCaveSpiderModel extends EntityModel<LuckyCaveSpiderEntity> {
    ...
    public LuckyCaveSpiderModel(ModelPart root) {
    ...
    @Override
    public void setAngles(LuckyCaveSpiderEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
