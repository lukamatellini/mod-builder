...
/**
 * Entity model for Lucky Creeper
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class LuckyCreeperModel extends EntityModel<LuckyCreeperEntity> {
    ...
    public LuckyCreeperModel(ModelPart root) {
    ...
    @Override
    public void setAngles(LuckyCreeperEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
