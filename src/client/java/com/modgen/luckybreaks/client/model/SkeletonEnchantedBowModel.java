...
/**
 * Entity model for Skeleton (Enchanted Bow)
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class SkeletonEnchantedBowModel extends EntityModel<SkeletonEnchantedBowEntity> {
    ...
    public SkeletonEnchantedBowModel(ModelPart root) {
    ...
    @Override
    public void setAngles(SkeletonEnchantedBowEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
