...
/**
 * Entity model for Zombie (Iron Armor)
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class ZombieIronArmorModel extends EntityModel<ZombieIronArmorEntity> {
    ...
    public ZombieIronArmorModel(ModelPart root) {
    ...
    @Override
    public void setAngles(ZombieIronArmorEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
