...
/**
 * Entity model for Spider (Skeleton Rider)
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class SpiderSkeletonRiderModel extends EntityModel<SpiderSkeletonRiderEntity> {
    ...
    public SpiderSkeletonRiderModel(ModelPart root) {
    ...
    @Override
    public void setAngles(SpiderSkeletonRiderEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
