package com.modgen.luckybreaks.client.model;
...
/**
 * Entity model for Spider (Wither Skeleton Rider)
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class SpiderWitherSkeletonRiderModel extends EntityModel<SpiderWitherSkeletonRiderEntity> {
    ...
    public SpiderWitherSkeletonRiderModel(ModelPart root) {
    ...
    @Override
    public void setAngles(SpiderWitherSkeletonRiderEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
