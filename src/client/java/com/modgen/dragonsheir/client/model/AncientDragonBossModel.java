package com.modgen.dragonsheir.client.model;
...
/**
 * Entity model for Ancient Dragon
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class AncientDragonBossModel extends EntityModel<AncientDragonBossEntity> {
    ...
    @Override
    public void setAngles(AncientDragonBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
