...
/**
 * Entity model for Dragonling
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class DragonlingModel extends EntityModel<DragonlingEntity> {
    ...
    public DragonlingModel(ModelPart root) {
    ...
    @Override
    public void setAngles(DragonlingEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
