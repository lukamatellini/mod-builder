...
import com.modgen.dragonsheir.entity.ModGenNPCEntity;
...
public class NPCRenderer extends MobEntityRenderer<ModGenNPCEntity, NPCModel> {
    private static final Identifier DEFAULT_TEXTURE = Identifier.of("dragonsheir", "textures/entity/npc_default.png");
    ...
    public Identifier getTexture(ModGenNPCEntity entity) {
        ...
        if (npcId != null && !npcId.isEmpty()) {
            return Identifier.of("dragonsheir", "textures/entity/npc_" + npcId + ".png");
        }
