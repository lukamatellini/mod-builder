...
/**
 * Custom sky renderer for the The Void dimension
 * Renders themed sky, sun, moon, and atmospheric effects
 * MC 1.21.1 COMPATIBLE - Uses GameRenderer shader methods
 */
public class VoidDimensionSkyRenderer {
    
    private static final Identifier SKY_TEXTURE = Identifier.of("shatteredconquest", "textures/environment/void_dimension_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("shatteredconquest", "textures/environment/void_dimension_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("shatteredconquest", "textures/environment/void_dimension_moon.png");
