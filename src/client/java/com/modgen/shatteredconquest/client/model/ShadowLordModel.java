...
/**
 * Entity model for Shadow Lord
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class ShadowLordModel extends EntityModel<ShadowLordBossEntity> {
    ...
    @Override
    public void setAngles(ShadowLordBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
