...
/**
 * Entity model for Crystal Golem
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class CrystalGolemModel extends EntityModel<CrystalGolemBossEntity> {
    ...
    @Override
    public void setAngles(CrystalGolemBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
