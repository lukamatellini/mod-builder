...
/**
 * Entity model for Void Serpent Hatchling
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class VoidSerpentHatchlingModel extends EntityModel<VoidSerpentHatchlingEntity> {
    ...
    public VoidSerpentHatchlingModel(ModelPart root) {
    ...
    @Override
    public void setAngles(VoidSerpentHatchlingEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
