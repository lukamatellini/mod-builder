...
/**
 * Entity model for Shadow Minion
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class ShadowMinionModel extends EntityModel<ShadowMinionEntity> {
    ...
    public ShadowMinionModel(ModelPart root) {
    ...
    @Override
    public void setAngles(ShadowMinionEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
