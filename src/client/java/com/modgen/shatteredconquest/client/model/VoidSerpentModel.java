package com.modgen.shatteredconquest.client.model;
...
/**
 * Entity model for Void Serpent
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class VoidSerpentModel extends EntityModel<VoidSerpentBossEntity> {
    ...
    public VoidSerpentModel(ModelPart root) {
    ...
    @Override
    public void setAngles(VoidSerpentBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
