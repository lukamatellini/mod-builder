package com.modgen.twilightgemcraft.client.model;
...
/**
 * Entity model for Night Prowler
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class NightProwlerModel extends EntityModel<NightProwlerEntity> {
    ...
    @Override
    public void setAngles(NightProwlerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
