...
import com.modgen.shatteredrealms.client.model.TheVoidTitanModel;
...
public class TheVoidTitanRenderer extends MobEntityRenderer<TheVoidTitanBossEntity, TheVoidTitanModel> {
    private static final Identifier TEXTURE = Identifier.of("shatteredrealms", "textures/entity/the_void_titan.png");
