...
/**
 * Entity model for Burrowing Worm
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class BurrowingWormModel extends EntityModel<BurrowingWormEntity> {
    ...
    public BurrowingWormModel(ModelPart root) {
    ...
    @Override
    public void setAngles(BurrowingWormEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
