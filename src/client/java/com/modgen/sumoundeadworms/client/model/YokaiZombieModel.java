...
/**
 * Entity model for Yokai Zombie
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class YokaiZombieModel extends EntityModel<YokaiZombieEntity> {
    ...
    public YokaiZombieModel(ModelPart root) {
    ...
    @Override
    public void setAngles(YokaiZombieEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
