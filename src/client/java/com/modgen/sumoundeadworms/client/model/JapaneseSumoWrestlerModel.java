package com.modgen.sumoundeadworms.client.model;
...
/**
 * Entity model for Japanese Sumo Wrestler
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class JapaneseSumoWrestlerModel extends EntityModel<JapaneseSumoWrestlerEntity> {
    ...
    public JapaneseSumoWrestlerModel(ModelPart root) {
    ...
    @Override
    public void setAngles(JapaneseSumoWrestlerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
