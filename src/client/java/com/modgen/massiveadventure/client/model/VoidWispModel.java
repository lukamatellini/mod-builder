...
/**
 * Entity model for Void Wisp
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class VoidWispModel extends EntityModel<VoidWispEntity> {
    ...
    public VoidWispModel(ModelPart root) {
    ...
    @Override
    public void setAngles(VoidWispEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
