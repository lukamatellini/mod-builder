package com.modgen.massiveadventure.client.model;
...
/**
 * Entity model for Void Overlord
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class VoidOverlordModel extends EntityModel<VoidOverlordBossEntity> {
    ...
    public VoidOverlordModel(ModelPart root) {
    ...
    @Override
    public void setAngles(VoidOverlordBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
