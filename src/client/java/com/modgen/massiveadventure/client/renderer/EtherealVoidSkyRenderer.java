...
/**
 * Custom sky renderer for the The Ethereal Void dimension
 * Renders themed sky, sun, moon, and atmospheric effects
 * MC 1.21.1 COMPATIBLE - Uses GameRenderer shader methods
 */
public class EtherealVoidSkyRenderer {
    
    private static final Identifier SKY_TEXTURE = Identifier.of("massiveadventure", "textures/environment/ethereal_void_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("massiveadventure", "textures/environment/ethereal_void_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("massiveadventure", "textures/environment/ethereal_void_moon.png");
