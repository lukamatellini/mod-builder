package com.modgen.luckylootboxes.client.model;
...
/**
 * Entity model for Cursed Spirit
 * Body type: flying
 */
@Environment(EnvType.CLIENT)
public class CursedSpiritModel extends EntityModel<CursedSpiritEntity> {
    private final ModelPart head;
    private final ModelPart body;
    private final ModelPart rightWing;
    private final ModelPart leftWing;
    
    public CursedSpiritModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CursedSpiritEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
