...
public class SkeletonModel extends EntityModel<SkeletonEntity> {
    ...
    @Override
    public void setAngles(SkeletonEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
