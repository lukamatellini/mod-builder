...
/**
 * Entity model for Evoker
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class EvokerModel extends EntityModel<EvokerEntity> {
    ...
    public EvokerModel(ModelPart root) {
    ...
    @Override
    public void setAngles(EvokerEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
