...
/**
 * Entity model for Lucky Goblin
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class LuckyGoblinModel extends EntityModel<LuckyGoblinEntity> {
    ...
    public LuckyGoblinModel(ModelPart root) {
    ...
    @Override
    public void setAngles(LuckyGoblinEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
