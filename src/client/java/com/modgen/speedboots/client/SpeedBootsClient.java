...
public class SpeedBootsClient implements ClientModInitializer {
    private static final Logger LOGGER = LoggerFactory.getLogger("speedboots/client");
    
    @Override
    public void onInitializeClient() {
        LOGGER.info("Initializing Speed Boots client...");
        ...
        LOGGER.info("Speed Boots client initialized");
    }
