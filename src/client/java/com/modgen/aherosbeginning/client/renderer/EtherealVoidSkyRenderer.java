...
public class EtherealVoidSkyRenderer {
    ...
    private static final Identifier SKY_TEXTURE = Identifier.of("aherosbeginning", "textures/environment/ethereal_void_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("aherosbeginning", "textures/environment/ethereal_void_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("aherosbeginning", "textures/environment/ethereal_void_moon.png");
