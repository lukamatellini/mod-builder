 ...
 */
public class TheVoidSkyRenderer {
    
    private static final Identifier SKY_TEXTURE = Identifier.of("voidconquest", "textures/environment/the_void_sky.png");
    private static final Identifier SUN_TEXTURE = Identifier.of("voidconquest", "textures/environment/the_void_sun.png");
    private static final Identifier MOON_TEXTURE = Identifier.of("voidconquest", "textures/environment/the_void_moon.png");
