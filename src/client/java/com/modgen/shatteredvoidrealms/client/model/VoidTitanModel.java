...
public class VoidTitanModel extends EntityModel<VoidTitanBossEntity> {
    ...
    @Override
    public void setAngles(VoidTitanBossEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
