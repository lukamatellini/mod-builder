...
/**
 * HUD Overlay System for Arcane Spark
...
public class ModHudOverlay implements HudRenderCallback {
    private static final Logger LOGGER = LoggerFactory.getLogger("arcanespark/hud");
    ...
    private static final Identifier HUD_ICONS = Identifier.of("arcanespark", "textures/gui/hud_icons.png");
