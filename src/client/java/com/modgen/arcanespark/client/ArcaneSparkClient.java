...
public class ArcaneSparkClient implements ClientModInitializer {
    private static final Logger LOGGER = LoggerFactory.getLogger("arcanespark/client");
    
    @Override
    public void onInitializeClient() {
        LOGGER.info("Initializing Arcane Spark client...");
        ...
        LOGGER.info("Arcane Spark client initialized");
    }
