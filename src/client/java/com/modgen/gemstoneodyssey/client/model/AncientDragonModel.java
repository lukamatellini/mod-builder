...
public class AncientDragonModel extends EntityModel<AncientDragonEntity> {
    ...
    @Override
    public void setAngles(AncientDragonEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
