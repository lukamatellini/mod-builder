...
/**
 * Entity model for Ignis, the Ancient Dragon
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class IgnisTheAncientDragonModel extends EntityModel<IgnisTheAncientDragonEntity> {
    ...
    public IgnisTheAncientDragonModel(ModelPart root) {
    ...
    @Override
    public void setAngles(IgnisTheAncientDragonEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
