...
/**
 * Entity model for Fire Elemental
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class FireElementalModel extends EntityModel<FireElementalEntity> {
    ...
    @Override
    public void setAngles(FireElementalEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
