...
public class UnicornModel extends EntityModel<UnicornEntity> {
    ...
    @Override
    public void setAngles(UnicornEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
