...
/**
 * Entity model for Sky Golem
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class SkyGolemModel extends EntityModel<SkyGolemEntity> {
    ...
    public SkyGolemModel(ModelPart root) {
    ...
    @Override
    public void setAngles(SkyGolemEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
