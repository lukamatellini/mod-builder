...
/**
 * Entity model for Gloomy Ghoul
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class GloomyGhoulModel extends EntityModel<GloomyGhoulEntity> {
    ...
    public GloomyGhoulModel(ModelPart root) {
    ...
    @Override
    public void setAngles(GloomyGhoulEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
