package com.modgen.gemstoneodyssey.client.model;
...
/**
 * Entity model for Benevolent Floating Creature
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class BenevolentFloatingCreatureModel extends EntityModel<BenevolentFloatingCreatureEntity> {
    ...
    public BenevolentFloatingCreatureModel(ModelPart root) {
    ...
    @Override
    public void setAngles(BenevolentFloatingCreatureEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
