...
/**
 * Entity model for Blaze Elemental
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class BlazeElementalModel extends EntityModel<BlazeElementalEntity> {
    ...
    public BlazeElementalModel(ModelPart root) {
    ...
    @Override
    public void setAngles(BlazeElementalEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
