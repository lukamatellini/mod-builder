...
/**
 * Entity model for Pirate
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class PirateModel extends EntityModel<PirateEntity> {
    ...
    @Override
    public void setAngles(PirateEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
