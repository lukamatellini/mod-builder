...
/**
 * Entity model for Ice Elemental
 * Body type: humanoid
 */
@Environment(EnvType.CLIENT)
public class IceElementalModel extends EntityModel<IceElementalEntity> {
    ...
    public IceElementalModel(ModelPart root) {
    ...
    @Override
    public void setAngles(IceElementalEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        // Head rotation
