# QA Test Plan: Risky Blocks

Generated: 2026-01-07T03:04:49.770Z
...
3. Place `riskyblocks.jar` in mods folder
4. Launch Minecraft
...
|------|-------------|---------|--------|---------------|
| Lucky Block | `/give @p riskyblocks:lucky_block` | ☐ | ☐ | ☐ |
| Dirt  | `/give @p riskyblocks:dirt_` | ☐ | ☐ | ☐ |
| Netherite Scrap 1 | `/give @p riskyblocks:netherite_scrap_1` | ☐ | ☐ | ☐ |
...
- [ ] Item appears in creative tab
- [ ] Texture displays correctly (not purple/black)
- [ ] Name displays correctly: "Netherite Scrap 1"
