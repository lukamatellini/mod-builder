# Mod QA Test Plan: Storm Caller

**Mod ID:** `stormcaller`
**Minecraft Version:** 1.21.1
**Generated:** 2026-01-04T20:58:44.739Z
**Total Tests:** 2
...
```
/give @p stormcaller:lightning_wand
```
...
**Command:** `/give @p stormcaller:lightning_wand`

**Steps:**
1. Run: /give @p stormcaller:lightning_wand
