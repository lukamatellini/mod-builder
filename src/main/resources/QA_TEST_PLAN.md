# Mod QA Test Plan: Arcane Spark

**Mod ID:** `arcanespark`
**Minecraft Version:** 1.21.1
**Generated:** 2026-01-04T22:06:10.123Z
**Total Tests:** 2
...
```
/give @p arcanespark:lightning_wand
```
...
**Command:** `/give @p arcanespark:lightning_wand`

**Steps:**
1. Run: /give @p arcanespark:lightning_wand
