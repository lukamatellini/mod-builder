# Mod QA Test Plan: Lightning Wand

**Mod ID:** `lightningwand`
**Minecraft Version:** 1.21.1
**Generated:** 2025-12-26T19:57:17.339Z
**Total Tests:** 2
...
```
/give @p lightningwand:lightning_wand
```
...
**Command:** `/give @p lightningwand:lightning_wand`

**Steps:**
1. Run: /give @p lightningwand:lightning_wand
