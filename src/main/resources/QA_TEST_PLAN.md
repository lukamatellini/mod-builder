...
Generated: 2026-01-07T03:18:37.408Z
...
| Minecraftregeneration Potion | `/give @p luckylootblocks:minecraftregeneration_potion` | ☐ | ☐ | ☐ |
| Minecraftweakness Potion | `/give @p luckylootblocks:minecraftweakness_potion` | ☐ | ☐ | ☐ |
...
#### Minecraftregeneration Potion

- [ ] Item appears in creative tab
- [ ] Texture displays correctly (not purple/black)
- [ ] Name displays correctly: "Minecraftregeneration Potion"

#### Minecraftweakness Potion

- [ ] Item appears in creative tab
- [ ] Texture displays correctly (not purple/black)
- [ ] Name displays correctly: "Minecraftweakness Potion"
