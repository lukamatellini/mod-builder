# Mod QA Test Plan: Arcane Volts

**Mod ID:** `arcanevolts`
**Minecraft Version:** 1.21.1
**Generated:** 2025-12-27T00:50:26.550Z
**Total Tests:** 2
...
```
/give @p arcanevolts:lightning_wand
```
...
**Command:** `/give @p arcanevolts:lightning_wand`

**Steps:**
1. Run: /give @p arcanevolts:lightning_wand
