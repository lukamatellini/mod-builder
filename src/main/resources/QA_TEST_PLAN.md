# Mod QA Test Plan: Storm Weaver

**Mod ID:** `stormweaver`
**Minecraft Version:** 1.21.1
**Generated:** 2025-12-27T14:26:09.528Z
**Total Tests:** 2
...
```
/give @p stormweaver:lightning_wand
```
...
**Command:** `/give @p stormweaver:lightning_wand`

**Steps:**
1. Run: /give @p stormweaver:lightning_wand
