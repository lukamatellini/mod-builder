# Mod QA Test Plan: Thunderstrike Wand

**Mod ID:** `thunderstrikewand`
**Minecraft Version:** 1.21.1
**Generated:** 2025-12-27T13:18:45.252Z
**Total Tests:** 2
...
```
/give @p thunderstrikewand:lightning_wand
```
...
**Command:** `/give @p thunderstrikewand:lightning_wand`

**Steps:**
1. Run: /give @p thunderstrikewand:lightning_wand
