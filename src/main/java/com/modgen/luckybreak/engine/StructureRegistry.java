package com.modgen.luckybreak.engine;
...
public class StructureRegistry {
    private static final Logger LOGGER = LoggerFactory.getLogger("luckybreak/structures");
    ...
    private void registerStructures() {
        structures.put("lucky_block_cluster", new StructureData(
            "lucky_block_cluster",
            "Lucky Block Cluster",
            "underground",
            new BlockPlacement[] {
                ...
                new BlockPlacement(1, 1, 2, Blocks.STONE),
                new BlockPlacement(2, 1, 0, Blocks.STONE),
                new BlockPlacement(2, 1, 1, Blocks.STONE),
                new BlockPlacement(2, 1, 2, Blocks.STONE),
                new BlockPlacement(0, 2, 0, Blocks.STONE),
                new BlockPlacement(0, 2, 1, Blocks.STONE),
                new BlockPlacement(0, 2, 2, Blocks.STONE),
                new BlockPlacement(1, 2, 2, Blocks.STONE),
                new BlockPlacement(2, 2, 0, Blocks.STONE),
                new BlockPlacement(2, 2, 1, Blocks.STONE),
                new BlockPlacement(2, 2, 2, Blocks.STONE),
                ...
                new BlockPlacement(1, 3, 1, Blocks.STONE),
                new BlockPlacement(1, 3, 2, Blocks.STONE),
                new BlockPlacement(2, 3, 0, Blocks.STONE),
                new BlockPlacement(2, 3, 1, Blocks.STONE),
                new BlockPlacement(2, 3, 2, Blocks.STONE),
