...
public class FortuneFollies implements ModInitializer {
    public static final String MOD_ID = "fortunefollies";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Fortune & Follies");
        ...
        LOGGER.info("Fortune & Follies initialized successfully!");
    }
}