...
public class ModBlocks {
    ...
    public static Block MINECRAFTSTONE;
    ...
    public static void registerBlocks() {
        LuckyBlock.LOGGER.info("Registering blocks for " + LuckyBlock.MOD_ID);
        ...
        MINECRAFTSTONE = registerBlock("minecraftstone", 
            settings -> new Block(settings), 
            AbstractBlock.Settings.create()
            .hardness(1.5f)
            .resistance(6f)
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        ...
        if (MINECRAFTSTONE != null) entries.add(MINECRAFTSTONE.asItem());
    }
}