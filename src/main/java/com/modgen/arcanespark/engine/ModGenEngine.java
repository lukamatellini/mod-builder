package com.modgen.arcanespark.engine;

import com.modgen.arcanespark.ArcaneSpark;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("arcanespark/engine");
