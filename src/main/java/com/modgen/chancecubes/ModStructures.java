...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("chancecubes/structures");
    
    public static void registerStructures() {
        ChanceCubes.LOGGER.info("Registering 1 structures for worldgen");
        
        // Register worldgen for: Lucky Shrine
        registerStructureFeature("lucky_shrine", BiomeSelectors.tag(BiomeTags.IS_FOREST), 500);
    ...
    private static void registerStructureFeature(String structureId, Predicate<net.fabricmc.fabric.api.biome.v1.BiomeSelectionContext> biomeSelector, int chancePerChunk) {
        ...
        net.fabricmc.fabric.api.event.lifecycle.v1.ServerChunkEvents.CHUNK_LOAD.register((world, chunk) -> {
            ...
            var structureData = ChanceCubes.STRUCTURE_REGISTRY.getStructure(structureId);
