...
import com.modgen.chancecubes.engine.ModGenEngine;
import com.modgen.chancecubes.engine.BuildPlanValidator;
import com.modgen.chancecubes.command.ModGenCommand;
import com.modgen.chancecubes.engine.StructureRegistry;
import com.modgen.chancecubes.network.ModNetworking;
...
public class ChanceCubes implements ModInitializer {
    public static final String MOD_ID = "chancecubes";
    ...
    public void onInitialize() {
        ...
        LOGGER.info("  ✓ Registered 2 mobs + 0 NPC types");
        ...
        LOGGER.info("Chance Cubes initialized successfully!");
    }
}