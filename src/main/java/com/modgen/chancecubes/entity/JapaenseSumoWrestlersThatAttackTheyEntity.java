...
public class JapaenseSumoWrestlersThatAttackTheyEntity extends HostileEntity {
    // No ability cooldowns
    
    public JapaenseSumoWrestlersThatAttackTheyEntity(EntityType<? extends JapaenseSumoWrestlersThatAttackTheyEntity> entityType, World world) {
