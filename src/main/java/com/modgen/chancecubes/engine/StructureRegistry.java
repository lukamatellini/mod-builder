package com.modgen.chancecubes.engine;
 ...
 * 
 * JSON files are at: data/chancecubes/structures/{id}.json
 */
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("lucky_block");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("chancecubes", "structures/" + structureId + ".json");
