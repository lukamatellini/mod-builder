...
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("ruined_alchemist_lab", "crystal_forge", "void_obelisk", "corrupted_village", "shadow_shrine", "void_kings_citadel", "the_abyssal_void_structure");
