 ...
 * 
 * JSON files are at: data/epicadventure/structures/{id}.json
 */
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("ruined_alchemist_lab", "crystal_forge_structure", "void_obelisk", "corrupted_village", "shadow_shrine", "void_kings_citadel", "abyssal_void_structure");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("epicadventure", "structures/" + structureId + ".json");
