...
public class QuestEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("epicadventure/quests");
    ...
    private Path getSaveDirectory(MinecraftServer server) {
        return server.getSavePath(WorldSavePath.ROOT).resolve("epicadventure_quests");
    }
