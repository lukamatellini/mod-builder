package com.modgen.epicadventure.engine;
...
public class TradingSystem {
    private static final Logger LOGGER = LoggerFactory.getLogger("epicadventure/trading");
    ...
    private void registerTrades() {
            addTrade("elder_sage", new TradeOffer(
                "minecraft:void_silk", 16,
                null, 0,
                "1", 1,
                10, 2, 0
            ));
            addTrade("wandering_alchemist", new TradeOffer(
                "minecraft:crystal_shards", 8,
                null, 0,
                "1", 1,
                10, 2, 0
            ));
    ...
    public List<TradeOffer> getAvailableTradesForPlayer(ServerPlayerEntity player, String npcId) {
        ...
        int playerRep = EpicAdventure.REPUTATION_SYSTEM.getReputation(player.getUuid(), npcId);
    ...
    public TradeResult executeTrade(ServerPlayerEntity player, String npcId, int tradeIndex) {
        ...
        EpicAdventure.REPUTATION_SYSTEM.modifyReputation(player.getUuid(), npcId, 1);
    ...
    private Item resolveItem(String itemId) {
        try {
            Identifier id = itemId.contains(":") ? Identifier.of(itemId) : Identifier.of("epicadventure", itemId);
