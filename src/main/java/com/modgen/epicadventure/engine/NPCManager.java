...
public class NPCManager {
    private static final Logger LOGGER = LoggerFactory.getLogger("epicadventure/npcs");
    ...
    private void registerNPCDefinitions() {
        npcDefinitions.put("elder_sage", new NPCDefinition(
            "elder_sage",
            "Elder Sage",
            "Keeper of Ancient Lore",
            "none"
        ));
        npcDefinitions.put("wandering_alchemist", new NPCDefinition(
            "wandering_alchemist",
            "Wandering Alchemist",
            "Mysterious Potion Brewer",
            "none"
        ));
        npcDefinitions.put("crystal_guardian", new NPCDefinition(
            "crystal_guardian",
            "Crystal Guardian",
            "Protector of the Forge",
            "none"
        ));
        npcDefinitions.put("void_kings_herald", new NPCDefinition(
            "void_kings_herald",
            "Void King's Herald",
            "The Announcer",
            "none"
