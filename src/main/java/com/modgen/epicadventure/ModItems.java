...
import com.modgen.epicadventure.item.WraithCloakItem;
...
public class ModItems {
    ...
    public static Item VOID_BLADE_HANDLE;
    ...
    public static void registerItems() {
        ...
        VOID_BLADE_HANDLE = registerItem("void_blade_handle", Item::new, new Item.Settings().maxDamage(500).rarity(Rarity.UNCOMMON));
        VOID_BLADE = registerItem("void_blade", settings -> new SwordItem(ToolMaterials.DIAMOND, settings), new Item.Settings().maxCount(1).maxDamage(800).rarity(Rarity.RARE).attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND, 3, -2.4f)));
        CRYSTAL_PICKAXE = registerItem("crystal_pickaxe", settings -> new PickaxeItem(ToolMaterials.DIAMOND, settings), new Item.Settings().maxCount(1).maxDamage(1500).rarity(Rarity.RARE).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.DIAMOND, 1, -2.8f)));
        WRAITH_CLOAK = registerItem("wraith_cloak", WraithCloakItem::new, new Item.Settings().maxCount(1).maxDamage(600).rarity(Rarity.EPIC));
        ...
        POTION_OF_VOID_SIGHT = registerItem("potion_of_void_sight", Item::new, new Item.Settings().food(new FoodComponent.Builder().nutrition(6).saturationModifier(0.8f).build()));
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        ...
        if (VOID_BLADE_HANDLE != null) entries.add(VOID_BLADE_HANDLE);
