...
public class ModItems {
    ...
    public static void registerItems() {
        ...
        CRYSTAL_PICKAXE = registerItem("crystal_pickaxe", settings -> new PickaxeItem(ToolMaterials.DIAMOND, settings), new Item.Settings().maxCount(1).maxDamage(5000).rarity(Rarity.EPIC).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.DIAMOND, 1, -2.8f)));
        WRAITH_CLOAK = registerItem("wraith_cloak", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, settings), new Item.Settings().maxCount(1).maxDamage(150).rarity(Rarity.RARE));
