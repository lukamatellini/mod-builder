...
import com.modgen.epicadventure.entity.VoidWalkerEntity;
...
public class ModEntities {
    public static final EntityType<VoidWalkerEntity> VOID_WALKER = Registry.register(
        ...
        Identifier.of(EpicAdventure.MOD_ID, "void_walker"),
    ...
    public static final EntityType<TheVoidTitanBossEntity> THE_VOID_TITAN = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(EpicAdventure.MOD_ID, "the_void_titan"),
    ...
    public static final EntityType<CrystalEmpressBossEntity> CRYSTAL_EMPRESS = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(EpicAdventure.MOD_ID, "crystal_empress"),
    ...
    public static void registerEntities() {
        ...
        EpicAdventure.LOGGER.info("Registering natural spawn rules for 3 mobs");
