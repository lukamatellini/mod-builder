...
public class ModGenCommand {
    ...
    private static final List<String> STRUCTURE_IDS = Arrays.asList("ruined_alchemist_lab", "crystal_forge_structure", "void_obelisk", "corrupted_village", "shadow_shrine", "void_kings_citadel", "abyssal_void_structure");
    ...
    private static int debug(CommandContext<ServerCommandSource> ctx) {
        ...
        source.sendMessage(Text.literal("§6║ §7Items:      §f18"));
