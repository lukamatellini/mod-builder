package com.modgen.solidcheese.engine;

import com.modgen.solidcheese.SolidCheese;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("solidcheese/engine");
