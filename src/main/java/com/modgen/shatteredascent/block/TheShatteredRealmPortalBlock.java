package com.modgen.shatteredascent.block;
...
public class TheShatteredRealmPortalBlock extends Block {
    
    private static final RegistryKey<World> DIMENSION_KEY = RegistryKey.of(
        RegistryKeys.WORLD, Identifier.of(ShatteredAscent.MOD_ID, "the_shattered_realm")
    );
    
    public TheShatteredRealmPortalBlock(Settings settings) {
        super(settings);
    }
