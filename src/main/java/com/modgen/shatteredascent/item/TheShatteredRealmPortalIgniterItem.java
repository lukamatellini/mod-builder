package com.modgen.shatteredascent.item;
...
public class TheShatteredRealmPortalIgniterItem extends Item {
    
    public TheShatteredRealmPortalIgniterItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            // Generic action
            player.sendMessage(Text.literal("§aUsed The Shattered Realm Portal Key!"), true);
        }
