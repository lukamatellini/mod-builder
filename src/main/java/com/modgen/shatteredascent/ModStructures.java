...
import com.modgen.shatteredascent.engine.StructureRegistry;
...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredascent/structures");
    
    public static void registerStructures() {
        ShatteredAscent.LOGGER.info("Registering 4 structures for worldgen");
