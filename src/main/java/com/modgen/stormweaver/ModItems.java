...
import com.modgen.stormweaver.item.LightningWandItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        Identifier id = Identifier.of(StormWeaver.MOD_ID, name);
    ...
    public static void registerItems() {
        ...
        LIGHTNING_WAND = registerItem("lightning_wand", LightningWandItem::new, new Item.Settings().maxCount(1).maxDamage(150).rarity(Rarity.UNCOMMON));
    }
