...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormweaver/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (StormWeaver.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (StormWeaver.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}