package com.modgen.blazebrand.engine;

import com.modgen.blazebrand.BlazeBrand;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("blazebrand/engine");
