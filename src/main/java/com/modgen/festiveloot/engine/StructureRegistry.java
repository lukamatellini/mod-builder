package com.modgen.festiveloot.engine;
...
public class StructureRegistry {
    ...
    private void registerStructures() {
        structures.put("christmas_present_block", new StructureData(
            "christmas_present_block",
            "Christmas Present Block",
            "surface",
            new BlockPlacement[] {
                new BlockPlacement(0, 0, 0, Blocks.STONE),
                new BlockPlacement(0, 1, 0, Blocks.RED_WOOL),
                new BlockPlacement(0, 0, 0, Blocks.GLOWSTONE)
            }
        ));
