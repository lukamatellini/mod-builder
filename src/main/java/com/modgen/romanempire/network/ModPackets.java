package com.modgen.romanempire.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("romanempire", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("romanempire", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("romanempire", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("romanempire", "dialogue_choice");
