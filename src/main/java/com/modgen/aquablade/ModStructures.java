...
import com.modgen.aquablade.engine.StructureRegistry;
...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("aquablade/structures");
    
    public static void registerStructures() {
        AquaBlade.LOGGER.info("Registering 1 structures for worldgen");
        
        // Register worldgen for: Water Ore
        registerStructureFeature("water_ore", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
    ...
    private static void registerStructureFeature(String structureId, Predicate<net.fabricmc.fabric.api.biome.v1.BiomeSelectionContext> biomeSelector, int chancePerChunk) {
        ...
        net.fabricmc.fabric.api.event.lifecycle.v1.ServerChunkEvents.CHUNK_LOAD.register((world, chunk) -> {
            ...
            var structureData = AquaBlade.STRUCTURE_REGISTRY.getStructure(structureId);
