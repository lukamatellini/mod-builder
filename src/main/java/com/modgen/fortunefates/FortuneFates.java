...
public class FortuneFates implements ModInitializer {
    public static final String MOD_ID = "fortunefates";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Fortune Fates");
        ...
        LOGGER.info("Fortune Fates initialized successfully!");
    }
}