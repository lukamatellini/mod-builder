package com.modgen.stormcallersrod.engine;

import com.modgen.stormcallersrod.StormcallersRod;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormcallersrod/engine");
