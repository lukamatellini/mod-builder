...
import com.modgen.stormcallerstaff.item.LightningWandItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        Identifier id = Identifier.of(StormcallerStaff.MOD_ID, name);
    ...
    public static void registerItems() {
        StormcallerStaff.LOGGER.info("Registering items for " + StormcallerStaff.MOD_ID);
