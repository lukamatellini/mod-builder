package com.modgen.stormcallerstaff.engine;

import com.modgen.stormcallerstaff.StormcallerStaff;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormcallerstaff/engine");
