package com.modgen.lightningwand.engine;

import com.modgen.lightningwand.LightningWand;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("lightningwand/engine");
