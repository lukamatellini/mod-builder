...
import com.modgen.fortunesfolly.engine.ModGenEngine;
import com.modgen.fortunesfolly.engine.BuildPlanValidator;
...
public class FortunesFolly implements ModInitializer {
    public static final String MOD_ID = "fortunesfolly";
    ...
    public void onInitialize() {
        ...
        LOGGER.info("  ✓ Registered 4 mobs + 0 NPC types");
        ...
        LOGGER.info("Fortunes Folly initialized successfully!");
    }
}