...
public class ModBlocks {
    ...
    public static Block DOHO_RING_BLOCK;
    ...
    public static void registerBlocks() {
        YokaiUprising.LOGGER.info("Registering blocks for " + YokaiUprising.MOD_ID);
        DOHO_RING_BLOCK = registerBlock("doho_ring_block", 
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        if (DOHO_RING_BLOCK != null) entries.add(DOHO_RING_BLOCK.asItem());
    }
}