...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredrealmsreviv/structures");
    
    public static void registerStructures() {
        ShatteredRealmsRevival.LOGGER.info("Registering 5 structures for worldgen");
        ...
        registerStructureFeature("titan_s_arena", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: The Crystal Throne
        registerStructureFeature("the_crystal_throne", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
