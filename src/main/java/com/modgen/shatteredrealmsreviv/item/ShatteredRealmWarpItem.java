package com.modgen.shatteredrealmsreviv.item;
 ...
 */
public class ShatteredRealmWarpItem extends Item {
    
    private static final RegistryKey<World> DIMENSION_KEY = RegistryKey.of(
        RegistryKeys.WORLD, Identifier.of(ShatteredRealmsRevival.MOD_ID, "shattered_realm")
    );
    
    public ShatteredRealmWarpItem(Settings settings) {
        super(settings);
    }
