...
import com.modgen.shatteredrealmsreviv.engine.DialogueEngine;
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(ModPackets.DialogueChoicePayload.ID, (payload, context) -> {
            ...
            player.getServer().execute(() -> {
                ShatteredRealmsRevival.NPC_MANAGER.getDialogueEngine().selectChoice(player, payload.choiceIndex());
            });
        });
        
        ShatteredRealmsRevival.LOGGER.info("Registered server networking");
    }
