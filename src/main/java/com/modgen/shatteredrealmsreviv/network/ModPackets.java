package com.modgen.shatteredrealmsreviv.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("shatteredrealmsreviv", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("shatteredrealmsreviv", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("shatteredrealmsreviv", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("shatteredrealmsreviv", "dialogue_choice");
    public static final Identifier PROGRESS_BAR_UPDATE_ID = Identifier.of("shatteredrealmsreviv", "progress_bar_update");
