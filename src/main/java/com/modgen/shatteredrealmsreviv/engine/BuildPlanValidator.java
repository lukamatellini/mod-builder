package com.modgen.shatteredrealmsreviv.engine;
...
public class BuildPlanValidator {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredrealmsreviv/validator");
    
    // Build Plan expectations (from build-plan.json)
    public static final String MINECRAFT_RANGE = ">=1.21 <1.22";
    public static final int EXPECTED_ITEMS = 25;
    public static final int EXPECTED_MOBS = 5;
    public static final int EXPECTED_STRUCTURES = 5;
