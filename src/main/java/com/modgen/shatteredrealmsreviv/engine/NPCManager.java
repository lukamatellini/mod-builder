...
public class NPCManager {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredrealmsreviv/npcs");
    ...
    private void registerNPCDefinitions() {
        ...
        npcDefinitions.put("crystal_smith", new NPCDefinition(
            "crystal_smith",
            "Crystal Smith",
            "Artisan of the Shards",
            "none"
        ));
        npcDefinitions.put("shadow_guide", new NPCDefinition(
            "shadow_guide",
            "Shadow Guide",
            "Navigator of the Void",
            "none"
        ));
