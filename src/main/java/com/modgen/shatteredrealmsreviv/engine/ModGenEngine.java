...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredrealmsreviv/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (ShatteredRealmsRevival.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (ShatteredRealmsRevival.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}