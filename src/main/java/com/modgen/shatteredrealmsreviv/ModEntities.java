...
import com.modgen.shatteredrealmsreviv.entity.CrystalGolemEntity;
import com.modgen.shatteredrealmsreviv.entity.ShadowWraithEntity;
import com.modgen.shatteredrealmsreviv.entity.TheVoidTitanBossEntity;
import com.modgen.shatteredrealmsreviv.entity.CrystalEmpressBossEntity;
...
public class ModEntities {
    public static final EntityType<VoidWalkerEntity> VOID_WALKER = Registry.register(
        ...
        Identifier.of(ShatteredRealmsRevival.MOD_ID, "void_walker"),
    ...
    public static final EntityType<CrystalGolemEntity> CRYSTAL_GOLEM = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredRealmsRevival.MOD_ID, "crystal_golem"),
    ...
    public static final EntityType<ShadowWraithEntity> SHADOW_WRAITH = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredRealmsRevival.MOD_ID, "shadow_wraith"),
    ...
    public static final EntityType<TheVoidTitanBossEntity> THE_VOID_TITAN = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredRealmsRevival.MOD_ID, "the_void_titan"),
    ...
    public static final EntityType<CrystalEmpressBossEntity> CRYSTAL_EMPRESS = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredRealmsRevival.MOD_ID, "crystal_empress"),
    ...
    public static final EntityType<ModGenNPCEntity> NPC_ENTITY_TYPE = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredRealmsRevival.MOD_ID, "npc"),
    ...
    public static void registerEntities() {
        ShatteredRealmsRevival.LOGGER.info("Registering entities for " + ShatteredRealmsRevival.MOD_ID);
        ...
        ShatteredRealmsRevival.LOGGER.info("Registering natural spawn rules for 3 mobs");
