...
import com.modgen.aherosbeginning.engine.ModGenEngine;
import com.modgen.aherosbeginning.engine.BuildPlanValidator;
import com.modgen.aherosbeginning.command.ModGenCommand;
import com.modgen.aherosbeginning.engine.QuestEngine;
import com.modgen.aherosbeginning.engine.NPCManager;
import com.modgen.aherosbeginning.engine.StructureRegistry;
...
public class AHerosBeginning implements ModInitializer {
    public static final String MOD_ID = "aherosbeginning";
    ...
    public void onInitialize() {
        LOGGER.info("╔════════════════════════════════════════╗");
        LOGGER.info("║  A Hero's Beginning                    ║");
        ...
        LOGGER.info("A Hero's Beginning initialized successfully!");
    }
}