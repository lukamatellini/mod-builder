...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("aherosbeginning", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("aherosbeginning", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("aherosbeginning", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("aherosbeginning", "dialogue_choice");
    public static final Identifier PROGRESS_BAR_UPDATE_ID = Identifier.of("aherosbeginning", "progress_bar_update");
