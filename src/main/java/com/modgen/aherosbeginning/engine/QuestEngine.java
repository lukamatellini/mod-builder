...
public class QuestEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("aherosbeginning/quests");
    ...
    private Path getSaveDirectory(MinecraftServer server) {
        return server.getSavePath(WorldSavePath.ROOT).resolve("aherosbeginning_quests");
    }
