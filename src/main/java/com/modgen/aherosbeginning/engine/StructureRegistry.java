 ...
 * 
 * JSON files are at: data/aherosbeginning/structures/{id}.json
 */
public class StructureRegistry {
    private static final Logger LOGGER = LoggerFactory.getLogger("aherosbeginning/structures");
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("ethereal_citadel", "ruined_village", "crystal_cave", "ethereal_void_structure");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("aherosbeginning", "structures/" + structureId + ".json");
