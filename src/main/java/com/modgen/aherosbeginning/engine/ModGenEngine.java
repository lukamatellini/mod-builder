...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("aherosbeginning/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (AHerosBeginning.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (AHerosBeginning.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}