...
import com.modgen.thunderstaffs.item.LightningWandItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        RegistryKey<Item> key = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(ThunderStaffs.MOD_ID, name));
    ...
    public static void registerItems() {
        ThunderStaffs.LOGGER.info("Registering items for " + ThunderStaffs.MOD_ID);
