package com.modgen.arcanevolts.engine;

import com.modgen.arcanevolts.ArcaneVolts;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("arcanevolts/engine");
