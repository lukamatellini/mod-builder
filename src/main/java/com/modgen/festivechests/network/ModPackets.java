package com.modgen.festivechests.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("festivechests", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("festivechests", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("festivechests", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("festivechests", "dialogue_choice");
