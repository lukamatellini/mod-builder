package com.modgen.swiftstrides.engine;

import com.modgen.swiftstrides.SwiftStrides;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("swiftstrides/engine");
