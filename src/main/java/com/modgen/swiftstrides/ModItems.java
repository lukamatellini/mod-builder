...
public class ModItems {
    ...
    public static void registerItems() {
        ...
        SWIFTFOOT_BOOTS = registerItem("swiftfoot_boots", settings -> new ArmorItem(ModArmorMaterial.DIAMOND_EQUIVALENT, EquipmentType.BOOTS, settings), new Item.Settings().maxCount(1).maxDamage(429).rarity(Rarity.EPIC));
    }
