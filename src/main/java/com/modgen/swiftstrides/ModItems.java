...
public class ModItems {
    ...
    public static void registerItems() {
        ...
        VELOCITY_BOOTS = registerItem("velocity_boots", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.BOOTS, settings), new Item.Settings().Settings().maxCount(1).maxDamage(250).rarity(Rarity.UNCOMMON));
    }
