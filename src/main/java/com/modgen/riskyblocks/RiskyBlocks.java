...
public class RiskyBlocks implements ModInitializer {
    public static final String MOD_ID = "riskyblocks";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Risky Blocks");
        ...
        LOGGER.info("Risky Blocks initialized successfully!");
    }
}