package com.modgen.slipperypeel.network;

import com.modgen.slipperypeel.SlipperyPeel;
import com.modgen.slipperypeel.client.screen.DialogueScreen;
import com.modgen.slipperypeel.client.screen.QuestJournalScreen;
import com.modgen.slipperypeel.engine.DialogueEngine;
...
public class ModNetworking {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("slipperypeel", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("slipperypeel", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("slipperypeel", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("slipperypeel", "dialogue_choice");
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(DialogueChoicePayload.ID, (payload, context) -> {
            context.server().execute(() -> {
                SlipperyPeel.NPC_MANAGER.getDialogueEngine().selectChoice(context.player(), payload.choiceIndex);
            });
        });
    }
