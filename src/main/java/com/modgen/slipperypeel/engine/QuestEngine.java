...
public class QuestEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("slipperypeel/quests");
    ...
    private Path getSaveDirectory(MinecraftServer server) {
        return server.getSavePath(WorldSavePath.ROOT).resolve("slipperypeel_quests");
    }
