...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("slipperypeel/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (SlipperyPeel.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (SlipperyPeel.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}