package com.modgen.strideenchant.engine;

import com.modgen.strideenchant.StrideEnchant;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("strideenchant/engine");
