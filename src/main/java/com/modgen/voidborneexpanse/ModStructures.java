...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("voidborneexpanse/structures");
    
    public static void registerStructures() {
        VoidborneExpanse.LOGGER.info("Registering 2 structures for worldgen");
        
        // Register worldgen for: Void Spire
        registerStructureFeature("void_spire", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Void Expanse Obelisk
        registerStructureFeature("void_expanse_structure", BiomeSelectors.foundInTheEnd(), 80);
