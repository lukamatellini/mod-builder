...
public class VoidExpansePortalIgniterItem extends Item {
    
    public VoidExpansePortalIgniterItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            // Generic action
            player.sendMessage(Text.literal("§aUsed Void Expanse Portal Key!"), true);
        }
