package com.modgen.voidborneexpanse.engine;
...
public class BuildPlanValidator {
    private static final Logger LOGGER = LoggerFactory.getLogger("voidborneexpanse/validator");
    
    // Build Plan expectations (from build-plan.json)
    public static final String MINECRAFT_RANGE = ">=1.21 <1.22";
    public static final int EXPECTED_ITEMS = 8;
    public static final int EXPECTED_MOBS = 0;
    public static final int EXPECTED_STRUCTURES = 2;
