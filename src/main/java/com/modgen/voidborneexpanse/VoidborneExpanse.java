...
import com.modgen.voidborneexpanse.engine.ModGenEngine;
import com.modgen.voidborneexpanse.engine.BuildPlanValidator;
import com.modgen.voidborneexpanse.command.ModGenCommand;
import com.modgen.voidborneexpanse.engine.StructureRegistry;
...
public class VoidborneExpanse implements ModInitializer {
    public static final String MOD_ID = "voidborneexpanse";
    ...
    public void onInitialize() {
        ...
        LOGGER.info("  ✓ Registered 8 items");


        // Register structures
        ModStructures.registerStructures();
        LOGGER.info("  ✓ Registered 2 structures");
        ...
        LOGGER.info("Voidborne Expanse initialized successfully!");
    }
}