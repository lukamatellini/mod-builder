package com.modgen.thunderstrikewand.network;

import com.modgen.thunderstrikewand.ThunderstrikeWand;
import com.modgen.thunderstrikewand.client.screen.DialogueScreen;
import com.modgen.thunderstrikewand.client.screen.QuestJournalScreen;
import com.modgen.thunderstrikewand.engine.DialogueEngine;
...
public class ModNetworking {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("thunderstrikewand", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("thunderstrikewand", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("thunderstrikewand", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("thunderstrikewand", "dialogue_choice");
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(DialogueChoicePayload.ID, (payload, context) -> {
            context.server().execute(() -> {
                ThunderstrikeWand.NPC_MANAGER.getDialogueEngine().selectChoice(context.player(), payload.choiceIndex);
            });
        });
    }
