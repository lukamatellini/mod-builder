...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("thunderstrikewand/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (ThunderstrikeWand.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (ThunderstrikeWand.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}