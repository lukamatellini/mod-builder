...
import com.modgen.stormcaller.client.screen.DialogueScreen;
import com.modgen.stormcaller.client.screen.QuestJournalScreen;
...
public class ModNetworking {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("stormcaller", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("stormcaller", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("stormcaller", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("stormcaller", "dialogue_choice");
