...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormcaller/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (StormCaller.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (StormCaller.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}