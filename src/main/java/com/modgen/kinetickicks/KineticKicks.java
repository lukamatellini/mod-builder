...
import com.modgen.kinetickicks.ModItems;

public class KineticKicks implements ModInitializer {
    public static final String MOD_ID = "kinetickicks";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Kinetic Kicks");
        ...
        LOGGER.info("Kinetic Kicks initialized successfully!");
    }
}