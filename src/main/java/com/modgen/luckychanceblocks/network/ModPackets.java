package com.modgen.luckychanceblocks.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("luckychanceblocks", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("luckychanceblocks", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("luckychanceblocks", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("luckychanceblocks", "dialogue_choice");
