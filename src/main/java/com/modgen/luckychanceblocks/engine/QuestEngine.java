...
public class QuestEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("luckychanceblocks/quests");
    ...
    private Path getSaveDirectory(MinecraftServer server) {
        return server.getSavePath(WorldSavePath.ROOT).resolve("luckychanceblocks_quests");
    }
