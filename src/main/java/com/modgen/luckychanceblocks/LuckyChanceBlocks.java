...
import com.modgen.luckychanceblocks.engine.ModGenEngine;
import com.modgen.luckychanceblocks.engine.QuestEngine;
import com.modgen.luckychanceblocks.engine.NPCManager;
import com.modgen.luckychanceblocks.engine.StructureRegistry;
import com.modgen.luckychanceblocks.engine.BuildPlanValidator;
import com.modgen.luckychanceblocks.command.ModGenCommand;
...
public class LuckyChanceBlocks implements ModInitializer {
    public static final String MOD_ID = "luckychanceblocks";
    ...
    public void onInitialize() {
        LOGGER.info("╔════════════════════════════════════════╗");
        LOGGER.info("║  Lucky Chance Blocks                   ║");
        ...
        LOGGER.info("  ✓ Registered 2 items");
        ...
        LOGGER.info("Lucky Chance Blocks initialized successfully!");
    }
}