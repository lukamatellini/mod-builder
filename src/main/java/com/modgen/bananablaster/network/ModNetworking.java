package com.modgen.bananablaster.network;

import com.modgen.bananablaster.BananaBlaster;
import com.modgen.bananablaster.client.screen.DialogueScreen;
import com.modgen.bananablaster.client.screen.QuestJournalScreen;
import com.modgen.bananablaster.engine.DialogueEngine;
...
public class ModNetworking {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("bananablaster", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("bananablaster", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("bananablaster", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("bananablaster", "dialogue_choice");
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(DialogueChoicePayload.ID, (payload, context) -> {
            context.server().execute(() -> {
                BananaBlaster.NPC_MANAGER.getDialogueEngine().selectChoice(context.player(), payload.choiceIndex);
            });
        });
    }
