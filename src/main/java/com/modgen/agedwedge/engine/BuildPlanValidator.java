package com.modgen.agedwedge.engine;
...
public class BuildPlanValidator {
    private static final Logger LOGGER = LoggerFactory.getLogger("agedwedge/validator");
    
    // Build Plan expectations (from build-plan.json)
    public static final String MINECRAFT_RANGE = ">=1.21 <1.22";
    public static final int EXPECTED_ITEMS = 0;
    ...
    public static final boolean MODULE_ITEMS = false;
