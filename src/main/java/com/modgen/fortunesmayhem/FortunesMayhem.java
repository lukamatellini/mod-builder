...
public class FortunesMayhem implements ModInitializer {
    public static final String MOD_ID = "fortunesmayhem";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Fortunes Mayhem");
        ...
        LOGGER.info("Fortunes Mayhem initialized successfully!");
    }
}