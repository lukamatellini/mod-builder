...
public class ModItems {
    ...
    public static Item SHATTERED_CRYSTAL;
    public static Item DIMENSION_TRAVELER;
    ...
    public static void registerItems() {
        ...
        VOID_HELMET = registerItem("void_helmet", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.HELMET, settings), new Item.Settings().maxCount(1).maxDamage(300).rarity(Rarity.EPIC));
        VOID_CHESTPLATE = registerItem("void_chestplate", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, settings), new Item.Settings().maxCount(1).maxDamage(400).rarity(Rarity.EPIC));
        VOID_LEGGINGS = registerItem("void_leggings", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.LEGGINGS, settings), new Item.Settings().maxCount(1).maxDamage(350).rarity(Rarity.EPIC));
        VOID_BOOTS = registerItem("void_boots", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.BOOTS, settings), new Item.Settings().maxCount(1).maxDamage(250).rarity(Rarity.EPIC));
        ...
        ABYSSAL_PICKAXE = registerItem("abyssal_pickaxe", settings -> new PickaxeItem(ToolMaterials.DIAMOND, settings), new Item.Settings().maxCount(1).maxDamage(1200).rarity(Rarity.EPIC).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.DIAMOND, 1, -2.8f)));
        SOUL_ORB = registerItem("soul_orb", SoulOrbItem::new, new Item.Settings().maxDamage(500).rarity(Rarity.RARE));
        VOID_INGOT = registerItem("void_ingot", Item::new, new Item.Settings().maxDamage(500).rarity(Rarity.UNCOMMON));
        SHATTERED_CRYSTAL = registerItem("shattered_crystal", Item::new, new Item.Settings().maxDamage(500).rarity(Rarity.UNCOMMON));
        DIMENSION_TRAVELER = registerItem("dimension_traveler", Item::new, new Item.Settings().maxDamage(500).rarity(Rarity.EPIC));
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        ...
        if (SHATTERED_CRYSTAL != null) entries.add(SHATTERED_CRYSTAL);
        if (DIMENSION_TRAVELER != null) entries.add(DIMENSION_TRAVELER);
