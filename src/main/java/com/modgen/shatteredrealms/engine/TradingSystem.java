...
public class TradingSystem {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredrealms/trading");
    ...
    private void registerTrades() {
            addTrade("crystal_smith", new TradeOffer(
                "minecraft:shattered_crystals", 10,
                null, 0,
                "1", 1,
                10, 2, 0
            ));
            addTrade("crystal_smith", new TradeOffer(
                "minecraft:shattered_crystals", 20,
                null, 0,
                "1", 1,
                10, 2, 0
            ));
            addTrade("crystal_smith", new TradeOffer(
                "minecraft:shattered_crystals", 30,
                null, 0,
                "1", 1,
                10, 2, 0
            ));
    ...
    public List<TradeOffer> getAvailableTradesForPlayer(ServerPlayerEntity player, String npcId) {
        ...
        int playerRep = ShatteredRealms.REPUTATION_SYSTEM.getReputation(player.getUuid(), npcId);
    ...
    public TradeResult executeTrade(ServerPlayerEntity player, String npcId, int tradeIndex) {
        ...
        ShatteredRealms.REPUTATION_SYSTEM.modifyReputation(player.getUuid(), npcId, 1);
    ...
    private Item resolveItem(String itemId) {
        try {
            Identifier id = itemId.contains(":") ? Identifier.of(itemId) : Identifier.of("shatteredrealms", itemId);
