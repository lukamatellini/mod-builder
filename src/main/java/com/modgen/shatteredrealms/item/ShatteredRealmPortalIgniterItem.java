package com.modgen.shatteredrealms.item;
...
public class ShatteredRealmPortalIgniterItem extends Item {
    
    public ShatteredRealmPortalIgniterItem(Settings settings) {
        super(settings);
    }
