...
import com.modgen.shatteredrealms.engine.StructureRegistry;
...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredrealms/structures");
    
    public static void registerStructures() {
        ShatteredRealms.LOGGER.info("Registering 5 structures for worldgen");
        
        // Register worldgen for: Void Shrine
        registerStructureFeature("void_shrine", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Crystal Cavern
        registerStructureFeature("crystal_cavern", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Titan's Arena
        registerStructureFeature("titan_arena", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Warp Pedestal
        registerStructureFeature("warp_pedestal_structure", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: The Shattered Realm Ruins
        registerStructureFeature("shattered_realm_structure", BiomeSelectors.foundInOverworld(), 80);
