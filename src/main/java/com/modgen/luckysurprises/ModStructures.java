...
public class ModStructures {
    ...
    public static void registerStructures() {
        LuckySurprises.LOGGER.info("Registering 1 structures for worldgen");
        
        // Register worldgen for: Lucky Block Shrine
        registerStructureFeature("lucky_block_shrine", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
