...
import com.modgen.antigravitygenerator.engine.ModGenEngine;
import com.modgen.antigravitygenerator.engine.BuildPlanValidator;
...
public class AntiGravityGenerator implements ModInitializer {
    public static final String MOD_ID = "antigravitygenerator";
    ...
    public void onInitialize() {
        LOGGER.info("╔════════════════════════════════════════╗");
        LOGGER.info("║  Anti-Gravity Generator                ║");
        ...
        LOGGER.info("Anti-Gravity Generator initialized successfully!");
    }
}