package com.modgen.antigravitygenerator.engine;

import com.modgen.antigravitygenerator.AntiGravityGenerator;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("antigravitygenerator/engine");
