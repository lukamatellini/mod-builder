...
import com.modgen.swiftstridelegacy.engine.ModGenEngine;
import com.modgen.swiftstridelegacy.engine.BuildPlanValidator;
...
public class SwiftstrideLegacy implements ModInitializer {
    public static final String MOD_ID = "swiftstridelegacy";
    ...
    public void onInitialize() {
        LOGGER.info("╔════════════════════════════════════════╗");
        LOGGER.info("║  Swiftstride Legacy                    ║");
        ...
        LOGGER.info("Swiftstride Legacy initialized successfully!");
    }
}