package com.modgen.swiftstridelegacy.engine;

import com.modgen.swiftstridelegacy.SwiftstrideLegacy;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("swiftstridelegacy/engine");
