package com.modgen.thunderstaffwield;

import com.modgen.thunderstaffwield.engine.ModGenEngine;
import com.modgen.thunderstaffwield.engine.BuildPlanValidator;
...
public class ThunderstaffWield implements ModInitializer {
    public static final String MOD_ID = "thunderstaffwield";
    ...
    public void onInitialize() {
        LOGGER.info("╔════════════════════════════════════════╗");
        LOGGER.info("║  Thunderstaff Wield                    ║");
        ...
        LOGGER.info("Thunderstaff Wield initialized successfully!");
    }
}