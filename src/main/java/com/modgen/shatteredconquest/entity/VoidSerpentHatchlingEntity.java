...
public class VoidSerpentHatchlingEntity extends HostileEntity {
    // No ability cooldowns
    
    public VoidSerpentHatchlingEntity(EntityType<? extends VoidSerpentHatchlingEntity> entityType, World world) {
