...
public class NPCManager {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredconquest/npcs");
    ...
    private void registerNPCDefinitions() {
        npcDefinitions.put("void_merchant", new NPCDefinition(
            "void_merchant",
            "Void Merchant",
            "Keeper of the Void",
            "none"
        ));
        npcDefinitions.put("shattered_explorer", new NPCDefinition(
            "shattered_explorer",
            "Shattered Explorer",
            "Lost Adventurer",
            "none"
