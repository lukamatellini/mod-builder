 ...
 * 
 * JSON files are at: data/shatteredconquest/structures/{id}.json
 */
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("shadow_altar", "crystal_cavern", "void_islets", "void_dimension_structure");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("shatteredconquest", "structures/" + structureId + ".json");
