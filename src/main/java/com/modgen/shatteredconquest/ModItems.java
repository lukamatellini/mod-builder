...
import com.modgen.shatteredconquest.item.VoidStaffItem;
import com.modgen.shatteredconquest.item.VoidWarpItemItem;
import com.modgen.shatteredconquest.item.VoidDimensionPortalIgniterItem;
...
public class ModItems {
    ...
    public static Item VOID_WARP_ITEM;
    public static Item OBSIDIAN_POWDER;
    public static Item VOID_SHARD;
    public static Item VOID_DIMENSION_PORTAL_IGNITER;
    ...
    public static void registerItems() {
        ShatteredConquest.LOGGER.info("Registering items for " + ShatteredConquest.MOD_ID);
        ...
        VOID_WARP_ITEM = registerItem("void_warp_item", VoidWarpItemItem::new, new Item.Settings().maxDamage(500).rarity(Rarity.RARE));
        OBSIDIAN_POWDER = registerItem("obsidian_powder", Item::new, new Item.Settings().maxDamage(500));
        VOID_SHARD = registerItem("void_shard", Item::new, new Item.Settings().maxDamage(500).rarity(Rarity.UNCOMMON));
        VOID_DIMENSION_PORTAL_IGNITER = registerItem("void_dimension_portal_igniter", VoidDimensionPortalIgniterItem::new, new Item.Settings().maxDamage(64).rarity(Rarity.EPIC));
    }
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        ...
        if (VOID_WARP_ITEM != null) entries.add(VOID_WARP_ITEM);
        if (OBSIDIAN_POWDER != null) entries.add(OBSIDIAN_POWDER);
        if (VOID_SHARD != null) entries.add(VOID_SHARD);
        if (VOID_DIMENSION_PORTAL_IGNITER != null) entries.add(VOID_DIMENSION_PORTAL_IGNITER);
    }
}