...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredconquest/structures");
    
    public static void registerStructures() {
        ShatteredConquest.LOGGER.info("Registering 4 structures for worldgen");
        
        // Register worldgen for: Shadow Altar
        registerStructureFeature("shadow_altar", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Crystal Cavern
        registerStructureFeature("crystal_cavern", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Void Islets
        registerStructureFeature("void_islets", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: The Void Obelisk
        registerStructureFeature("void_dimension_structure", BiomeSelectors.foundInOverworld(), 80);
