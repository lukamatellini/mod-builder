...
public class VoidDimensionPortalIgniterItem extends Item {
    
    public VoidDimensionPortalIgniterItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            // Generic action
            player.sendMessage(Text.literal("§aUsed The Void Portal Key!"), true);
        }
