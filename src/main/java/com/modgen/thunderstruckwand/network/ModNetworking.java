package com.modgen.thunderstruckwand.network;

import com.modgen.thunderstruckwand.ThunderstruckWand;
import com.modgen.thunderstruckwand.client.screen.DialogueScreen;
import com.modgen.thunderstruckwand.client.screen.QuestJournalScreen;
import com.modgen.thunderstruckwand.engine.DialogueEngine;
...
public class ModNetworking {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("thunderstruckwand", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("thunderstruckwand", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("thunderstruckwand", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("thunderstruckwand", "dialogue_choice");
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(DialogueChoicePayload.ID, (payload, context) -> {
            context.server().execute(() -> {
                ThunderstruckWand.NPC_MANAGER.getDialogueEngine().selectChoice(context.player(), payload.choiceIndex);
            });
        });
    }
