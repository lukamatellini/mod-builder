...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("thunderstruckwand/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (ThunderstruckWand.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (ThunderstruckWand.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}