package com.modgen.thunderstruckwand.engine;
 ...
 * 
 * RULES:
 * - Every structure ID must map to real block data
 * - NO demo structures - if ID has no data, FAIL LOUDLY
 * - All placements are server-authoritative
 */
public class StructureRegistry {
    private static final Logger LOGGER = LoggerFactory.getLogger("thunderstruckwand/structures");
    ...
    /**
     * STRICT structure lookup - returns null if ID not found
    ...
    /**
     * Get all valid structure IDs for command suggestions
     */
    ...
    public static class StructureData {
        ...
        /**
         * Place structure at position - returns number of blocks placed
         */
