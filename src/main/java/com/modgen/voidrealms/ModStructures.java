...
import com.modgen.voidrealms.engine.StructureRegistry;
...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("voidrealms/structures");
    
    public static void registerStructures() {
        VoidRealms.LOGGER.info("Registering 5 structures for worldgen");
        ...
        registerStructureFeature("titans_arena", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Crystal Throneroom
        registerStructureFeature("crystal_throneroom", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
