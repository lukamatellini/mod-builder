package com.modgen.voidrealms.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("voidrealms", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("voidrealms", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("voidrealms", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("voidrealms", "dialogue_choice");
    public static final Identifier PROGRESS_BAR_UPDATE_ID = Identifier.of("voidrealms", "progress_bar_update");
