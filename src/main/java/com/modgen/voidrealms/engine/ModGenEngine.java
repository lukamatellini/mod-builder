...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("voidrealms/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (VoidRealms.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (VoidRealms.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}