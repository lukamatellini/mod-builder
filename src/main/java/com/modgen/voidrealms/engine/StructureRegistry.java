 ...
 * 
 * JSON files are at: data/voidrealms/structures/{id}.json
 */
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("void_shrine", "crystal_cavern", "titans_arena", "crystal_throneroom", "shattered_realm_structure");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("voidrealms", "structures/" + structureId + ".json");
