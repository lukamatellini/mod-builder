...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("swiftstridetrails/structures");
    
    public static void registerStructures() {
        SwiftstrideTrails.LOGGER.info("Registering 1 structures for worldgen");
        
        // Register worldgen for: Swiftstone Ore
        registerStructureFeature("swiftstone_ore", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
