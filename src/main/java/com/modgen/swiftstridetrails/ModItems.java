...
public class ModItems {
    public static final Item SWIFTSTRIDE_BOOTS = registerItem("swiftstride_boots", new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.BOOTS, new Item.Settings().maxCount(1).maxDamage(400).rarity(Rarity.EPIC)));
