package com.modgen.swiftstridetrails.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("swiftstridetrails", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("swiftstridetrails", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("swiftstridetrails", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("swiftstridetrails", "dialogue_choice");
