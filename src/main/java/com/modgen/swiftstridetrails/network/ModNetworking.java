...
import com.modgen.swiftstridetrails.engine.DialogueEngine;
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(ModPackets.DialogueChoicePayload.ID, (payload, context) -> {
            ...
            player.getServer().execute(() -> {
                SwiftstrideTrails.NPC_MANAGER.getDialogueEngine().selectChoice(player, payload.choiceIndex());
            });
        });
        
        SwiftstrideTrails.LOGGER.info("Registered server networking");
    }
