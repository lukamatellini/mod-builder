package com.modgen.swiftfootboots.engine;

import com.modgen.swiftfootboots.SwiftfootBoots;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("swiftfootboots/engine");
