 ...
 * 
 * JSON files are at: data/abyssalascent/structures/{id}.json
 */
public class StructureRegistry {
    private static final Logger LOGGER = LoggerFactory.getLogger("abyssalascent/structures");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("abyssalascent", "structures/" + structureId + ".json");
