...
import com.modgen.abyssalascent.item.PurificationStaffItem;
import com.modgen.abyssalascent.item.AbyssalVoidPortalIgniterItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        Identifier id = Identifier.of(AbyssalAscent.MOD_ID, name);
    ...
    public static void registerItems() {
        AbyssalAscent.LOGGER.info("Registering items for " + AbyssalAscent.MOD_ID);
        ...
        ABYSSAL_COMPASS = registerItem("abyssal_compass", Item::new, new Item.Settings().maxDamage(500).rarity(Rarity.RARE));
        VOID_BLADE = registerItem("void_blade", settings -> new SwordItem(ToolMaterials.DIAMOND, settings), new Item.Settings().maxCount(1).maxDamage(800).rarity(Rarity.EPIC).attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND, 3, -2.4f)));
        ...
        WRAITH_CLOAK = registerItem("wraith_cloak", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, settings), new Item.Settings().maxCount(1).maxDamage(600).rarity(Rarity.EPIC));
        VOID_KINGS_CROWN = registerItem("void_kings_crown", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.HELMET, settings), new Item.Settings().maxCount(1).maxDamage(1500).rarity(Rarity.EPIC));
        ...
        POTION_OF_VOID_SIGHT = registerItem("potion_of_void_sight", Item::new, new Item.Settings().maxDamage(500).rarity(Rarity.RARE));
