...
public class ModEntities {
    public static final EntityType<VoidCrawlerEntity> VOID_CRAWLER = Registry.register(
        ...
        Identifier.of(AbyssalAscent.MOD_ID, "void_crawler"),
    ...
    public static final EntityType<ShadowWraithEntity> SHADOW_WRAITH = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(AbyssalAscent.MOD_ID, "shadow_wraith"),
    ...
    public static final EntityType<CrystalGolemEntity> CRYSTAL_GOLEM = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(AbyssalAscent.MOD_ID, "crystal_golem"),
    ...
    public static final EntityType<AbyssalLurkerEntity> ABYSSAL_LURKER = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(AbyssalAscent.MOD_ID, "abyssal_lurker"),
    ...
    public static final EntityType<CorruptedVillagerEntity> CORRUPTED_VILLAGER = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(AbyssalAscent.MOD_ID, "corrupted_villager"),
        EntityType.Builder.create(CorruptedVillagerEntity::new, SpawnGroup.MONSTER)
            .dimensions(0.6f, 1.8f)
            .build()
    );

    public static final EntityType<VoidKingBossEntity> VOID_KING = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(AbyssalAscent.MOD_ID, "void_king"),
        EntityType.Builder.create(VoidKingBossEntity::new, SpawnGroup.MISC)
    ...
    public static final EntityType<VoidCommanderEntity> VOID_COMMANDER = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(AbyssalAscent.MOD_ID, "void_commander"),
    ...
    public static final EntityType<ModGenNPCEntity> NPC_ENTITY_TYPE = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(AbyssalAscent.MOD_ID, "npc"),
    ...
    public static void registerEntities() {
        AbyssalAscent.LOGGER.info("Registering entities for " + AbyssalAscent.MOD_ID);
        ...
        FabricDefaultAttributeRegistry.register(VOID_KING, VoidKingBossEntity.createMobAttributes());
        ...
        AbyssalAscent.LOGGER.info("Registering natural spawn rules for 6 mobs");
