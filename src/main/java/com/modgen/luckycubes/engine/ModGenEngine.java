...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("luckycubes/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (LuckyCubes.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (LuckyCubes.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}