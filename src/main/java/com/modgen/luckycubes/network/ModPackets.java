package com.modgen.luckycubes.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("luckycubes", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("luckycubes", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("luckycubes", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("luckycubes", "dialogue_choice");
