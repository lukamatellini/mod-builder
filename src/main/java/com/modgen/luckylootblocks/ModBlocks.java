...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        LuckyLootBlocks.LOGGER.info("Registering blocks for " + LuckyLootBlocks.MOD_ID);
        ...
        RNG_BLOCK = registerBlock("rng_block", 
            settings -> new Block(settings), 
            AbstractBlock.Settings.create()
            .hardness(2f)
            .resistance(6f)
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        ...
        if (RNG_BLOCK != null) entries.add(RNG_BLOCK.asItem());
    }
}