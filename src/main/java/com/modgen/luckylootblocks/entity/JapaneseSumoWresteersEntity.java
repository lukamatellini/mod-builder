...
public class JapaneseSumoWresteersEntity extends HostileEntity {
    // No ability cooldowns
    
    public JapaneseSumoWresteersEntity(EntityType<? extends JapaneseSumoWresteersEntity> entityType, World world) {
