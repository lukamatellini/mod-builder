...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("swiftstrideboots", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("swiftstrideboots", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("swiftstrideboots", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("swiftstrideboots", "dialogue_choice");
