...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("swiftstrideboots/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (SwiftstrideBoots.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (SwiftstrideBoots.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}