package com.modgen.cheesenuggests.engine;

import com.modgen.cheesenuggests.CheeseNuggests;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("cheesenuggests/engine");
