...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("aetheriaascendant/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("NPC Manager: " + (AetheriaAscendant.NPC_MANAGER != null ? "OK" : "NULL"));
        LOGGER.info("Trading System: " + (AetheriaAscendant.TRADING_SYSTEM != null ? "OK" : "NULL"));
    }
}