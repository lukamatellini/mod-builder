...
public class NPCManager {
    private static final Logger LOGGER = LoggerFactory.getLogger("aetheriaascendant/npcs");
    ...
    private void registerNPCDefinitions() {
        npcDefinitions.put("aether_traveler", new NPCDefinition(
            "aether_traveler",
            "Aether Traveler",
            "Dimension Guide",
            "none"
        ));
        npcDefinitions.put("cloud_weaver", new NPCDefinition(
            "cloud_weaver",
            "Cloud Weaver",
            "Sky Merchant",
            "none"
