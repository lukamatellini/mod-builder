...
public class TeleportationScrollItem extends Item {
    
    public TeleportationScrollItem(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            double x = player.getX() + (random.nextDouble() - 0.5) * 15 * 2;
            double z = player.getZ() + (random.nextDouble() - 0.5) * 15 * 2;
