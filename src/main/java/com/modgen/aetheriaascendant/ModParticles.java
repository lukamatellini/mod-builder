...
public class ModParticles {
    ...
    public static void register() {
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(AetheriaAscendant.MOD_ID, "flame"), FLAME);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(AetheriaAscendant.MOD_ID, "nature"), NATURE);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(AetheriaAscendant.MOD_ID, "magic"), MAGIC);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(AetheriaAscendant.MOD_ID, "soul"), SOUL);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(AetheriaAscendant.MOD_ID, "void"), VOID);
    }
}