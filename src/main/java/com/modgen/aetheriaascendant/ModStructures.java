...
public class ModStructures {
    ...
    public static void registerStructures() {
        AetheriaAscendant.LOGGER.info("Registering 3 structures for worldgen");
        
        // Register worldgen for: Sky Temple
        registerStructureFeature("sky_temple", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: Cloud Village
        registerStructureFeature("cloud_village", BiomeSelectors.tag(BiomeTags.IS_FOREST), 20);
        // Register worldgen for: The Aether Sanctuary
        registerStructureFeature("aether_structure", BiomeSelectors.foundInOverworld(), 80);
