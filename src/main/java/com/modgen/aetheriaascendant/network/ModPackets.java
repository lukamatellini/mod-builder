package com.modgen.aetheriaascendant.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier DIALOGUE_ID = Identifier.of("aetheriaascendant", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("aetheriaascendant", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("aetheriaascendant", "dialogue_choice");
    public static final Identifier OPEN_TRADING_ID = Identifier.of("aetheriaascendant", "open_trading");
    public static final Identifier EXECUTE_TRADE_ID = Identifier.of("aetheriaascendant", "execute_trade");
    public static final Identifier PROGRESS_BAR_UPDATE_ID = Identifier.of("aetheriaascendant", "progress_bar_update");
