package com.modgen.cheesycraft.structure;
...
public class CheeseDungeonStructure {
    public static final int SIZE_X = 10;
    public static final int SIZE_Y = 8;
    public static final int SIZE_Z = 10;
    
    public static void register() {
        Cheesycraft.LOGGER.info("Registered structure: Cheese Dungeon");
    }
    ...
    public static void generate(World world, BlockPos origin) {
        Cheesycraft.LOGGER.info("Generating Cheese Dungeon at " + origin);
