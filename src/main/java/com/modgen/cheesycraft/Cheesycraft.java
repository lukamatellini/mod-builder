...
import com.modgen.cheesycraft.ModItems;
import com.modgen.cheesycraft.ModBlocks;
import com.modgen.cheesycraft.entity.ModEntities;
import com.modgen.cheesycraft.ModStructures;

public class Cheesycraft implements ModInitializer {
    public static final String MOD_ID = "cheesycraft";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing CheesyCraft");
        ...
        LOGGER.info("CheesyCraft initialized successfully!");
    }
}