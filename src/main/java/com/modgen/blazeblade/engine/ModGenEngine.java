package com.modgen.blazeblade.engine;

import com.modgen.blazeblade.BlazeBlade;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("blazeblade/engine");
