...
public class ModItems {
    public static final Item LIGHTNING_WAND = registerItem("lightning_wand", new LightningWandItem(new Item.Settings().maxCount(1).maxDamage(128).rarity(Rarity.UNCOMMON)));
