...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("thunderstaff/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (ThunderStaff.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (ThunderStaff.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}