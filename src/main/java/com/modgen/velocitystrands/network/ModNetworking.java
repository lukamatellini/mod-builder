...
import com.modgen.velocitystrands.engine.DialogueEngine;
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(ModPackets.DialogueChoicePayload.ID, (payload, context) -> {
            ...
            player.getServer().execute(() -> {
                VelocityStrands.NPC_MANAGER.getDialogueEngine().selectChoice(player, payload.choiceIndex());
            });
        });
        
        VelocityStrands.LOGGER.info("Registered server networking");
    }
