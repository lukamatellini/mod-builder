...
public class QuestEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("velocitystrands/quests");
    ...
    private Path getSaveDirectory(MinecraftServer server) {
        return server.getSavePath(WorldSavePath.ROOT).resolve("velocitystrands_quests");
    }
