package com.modgen.voidconquest.block;
...
public class ShatteredVoidPortalBlock extends Block {
    
    private static final RegistryKey<World> DIMENSION_KEY = RegistryKey.of(
        RegistryKeys.WORLD, Identifier.of(VoidConquest.MOD_ID, "shattered_void")
    );
    
    public ShatteredVoidPortalBlock(Settings settings) {
        super(settings);
    }
