...
public class ModPackets {
    ...
    public static final Identifier OPEN_TRADING_ID = Identifier.of("voidconquest", "open_trading");
    public static final Identifier EXECUTE_TRADE_ID = Identifier.of("voidconquest", "execute_trade");
    public static final Identifier OPEN_ACHIEVEMENTS_ID = Identifier.of("voidconquest", "open_achievements");
    public static final Identifier ACHIEVEMENT_UNLOCKED_ID = Identifier.of("voidconquest", "achievement_unlocked");
