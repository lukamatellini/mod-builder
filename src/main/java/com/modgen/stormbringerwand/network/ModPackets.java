package com.modgen.stormbringerwand.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("stormbringerwand", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("stormbringerwand", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("stormbringerwand", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("stormbringerwand", "dialogue_choice");
