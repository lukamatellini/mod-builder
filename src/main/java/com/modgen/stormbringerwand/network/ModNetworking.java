...
import com.modgen.stormbringerwand.engine.DialogueEngine;
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(ModPackets.DialogueChoicePayload.ID, (payload, context) -> {
            ...
            player.getServer().execute(() -> {
                StormbringerWand.NPC_MANAGER.getDialogueEngine().selectChoice(player, payload.choiceIndex());
            });
        });
        
        StormbringerWand.LOGGER.info("Registered server networking");
    }
