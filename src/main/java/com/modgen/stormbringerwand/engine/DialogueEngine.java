...
public class DialogueEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormbringerwand/dialogue");
    ...
    private void executeAction(ServerPlayerEntity player, DialogueAction action) {
        switch (action.type) {
            case "start_quest":
                StormbringerWand.QUEST_ENGINE.startQuest(player, action.questId);
                break;
            case "complete_quest":
                StormbringerWand.QUEST_ENGINE.completeQuest(player, action.questId);
                break;
            case "open_trade":
