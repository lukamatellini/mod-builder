...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormbringerwand/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (StormbringerWand.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (StormbringerWand.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}