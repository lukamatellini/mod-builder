package com.modgen.stormstaff.engine;

import com.modgen.stormstaff.StormStaff;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormstaff/engine");
