...
import com.modgen.wintergifts.engine.StructureRegistry;
...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("wintergifts/structures");
    
    public static void registerStructures() {
        WinterGifts.LOGGER.info("Registering 1 structures for worldgen");
        
        // Register worldgen for: Christmas Present
    ...
    private static void registerStructureFeature(String structureId, Predicate<net.fabricmc.fabric.api.biome.v1.BiomeSelectionContext> biomeSelector, int chancePerChunk) {
        ...
        net.fabricmc.fabric.api.event.lifecycle.v1.ServerChunkEvents.CHUNK_LOAD.register((world, chunk) -> {
            ...
            var structureData = WinterGifts.STRUCTURE_REGISTRY.getStructure(structureId);
