...
import com.modgen.shatteredvoidrealms.entity.ShadowWraithEntity;
...
public class ModEntities {
    public static final EntityType<VoidWalkerEntity> VOID_WALKER = Registry.register(
        ...
        Identifier.of(ShatteredVoidRealms.MOD_ID, "void_walker"),
    ...
    public static final EntityType<ShadowWraithEntity> SHADOW_WRAITH = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredVoidRealms.MOD_ID, "shadow_wraith"),
        EntityType.Builder.create(ShadowWraithEntity::new, SpawnGroup.MONSTER)
            .dimensions(0.6f, 1.8f)
            .build()
    );

    public static final EntityType<VoidTitanBossEntity> VOID_TITAN = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredVoidRealms.MOD_ID, "void_titan"),
        EntityType.Builder.create(VoidTitanBossEntity::new, SpawnGroup.MISC)
    ...
    public static final EntityType<CrystalEmpressBossEntity> CRYSTAL_EMPRESS = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(ShatteredVoidRealms.MOD_ID, "crystal_empress"),
    ...
    public static void registerEntities() {
        ...
        FabricDefaultAttributeRegistry.register(VOID_TITAN, VoidTitanBossEntity.createAttributes());
        ...
        ShatteredVoidRealms.LOGGER.info("Registering natural spawn rules for 3 mobs");
