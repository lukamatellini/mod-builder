...
public class WarpPedestalItem extends Item {
    
    public WarpPedestalItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            double x = player.getX() + (random.nextDouble() - 0.5) * 10 * 2;
            double z = player.getZ() + (random.nextDouble() - 0.5) * 10 * 2;
