...
public class BuildPlanValidator {
    ...
    public static final int EXPECTED_ITEMS = 9;
    public static final int EXPECTED_MOBS = 4;
    public static final int EXPECTED_STRUCTURES = 3;
    public static final int EXPECTED_DIMENSIONS = 1;
    public static final int EXPECTED_QUESTS = 2;
    public static final int EXPECTED_NPCS = 2;
