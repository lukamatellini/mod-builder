...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredvoidrealms/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (ShatteredVoidRealms.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (ShatteredVoidRealms.NPC_MANAGER != null ? "OK" : "NULL"));
        LOGGER.info("Trading System: " + (ShatteredVoidRealms.TRADING_SYSTEM != null ? "OK" : "NULL"));
    }
}