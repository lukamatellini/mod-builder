 ...
 * 
 * JSON files are at: data/shatteredvoidrealms/structures/{id}.json
 */
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("void_shrine", "crystal_cavern", "titan_arena", "shattered_realm_structure");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("shatteredvoidrealms", "structures/" + structureId + ".json");
