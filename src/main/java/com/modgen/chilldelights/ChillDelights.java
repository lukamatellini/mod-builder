...
import com.modgen.chilldelights.ModItems;

public class ChillDelights implements ModInitializer {
    public static final String MOD_ID = "chilldelights";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Chill Delights");
        ...
        LOGGER.info("Chill Delights initialized successfully!");
    }
}