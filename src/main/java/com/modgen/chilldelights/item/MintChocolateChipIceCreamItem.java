package com.modgen.chilldelights.item;

import com.modgen.chilldelights.ChillDelights;
...
public class MintChocolateChipIceCreamItem extends Item {
    
    public MintChocolateChipIceCreamItem(Settings settings) {
        super(settings);
    }
