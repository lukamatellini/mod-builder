...
import com.modgen.thunderstaffwand.item.LightningWandItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        Identifier id = Identifier.of(ThunderstaffWand.MOD_ID, name);
    ...
    public static void registerItems() {
        ThunderstaffWand.LOGGER.info("Registering items for " + ThunderstaffWand.MOD_ID);
