package com.modgen.thunderstaffwand.engine;

import com.modgen.thunderstaffwand.ThunderstaffWand;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("thunderstaffwand/engine");
