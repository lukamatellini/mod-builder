 ...
 * 
 * JSON files are at: data/etherealexpanse/structures/{id}.json
 */
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("void_expanse_structure");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("etherealexpanse", "structures/" + structureId + ".json");
