...
public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("etherealexpanse/structures");
    
    public static void registerStructures() {
        EtherealExpanse.LOGGER.info("Registering 1 structures for worldgen");
        
        // Register worldgen for: Void Expanse Obelisk
        registerStructureFeature("void_expanse_structure", BiomeSelectors.tag(BiomeTags.IS_FOREST), 80);
