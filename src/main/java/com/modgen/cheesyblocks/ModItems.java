...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        RegistryKey<Item> key = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(CheesyBlocks.MOD_ID, name));
    ...
    public static void registerItems() {
        ...
        CHEESE_BLOCK = registerItem("cheese_block", Item::new, new Item.Settings().maxDamage(500));
    }
