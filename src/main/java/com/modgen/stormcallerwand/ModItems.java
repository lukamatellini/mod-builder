...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        RegistryKey<Item> itemKey = RegistryKey.of(RegistryKeys.ITEM, Identifier.of(StormcallerWand.MOD_ID, name));
    ...
    public static void registerItems() {
        ...
        LIGHTNING_WAND = registerItem("lightning_wand", LightningWandItem::new, new Item.Settings().maxCount(1).maxDamage(128).rarity(Rarity.RARE));
    }
