package com.modgen.stormcallerwand.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("stormcallerwand", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("stormcallerwand", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("stormcallerwand", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("stormcallerwand", "dialogue_choice");
