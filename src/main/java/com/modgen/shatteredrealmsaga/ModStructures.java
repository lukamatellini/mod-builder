...
import com.modgen.shatteredrealmsaga.engine.StructureRegistry;
...
public class ModStructures {
    ...
    public static void registerStructures() {
        ShatteredRealmSaga.LOGGER.info("Registering 4 structures for worldgen");
        ...
        registerStructureFeature("the_shattered_realm_structure", BiomeSelectors.foundInOverworld(), 80);
