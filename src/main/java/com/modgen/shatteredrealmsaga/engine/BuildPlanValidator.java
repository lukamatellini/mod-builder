...
public class BuildPlanValidator {
    private static final Logger LOGGER = LoggerFactory.getLogger("shatteredrealmsaga/validator");
    ...
    public static final int EXPECTED_MOBS = 5;
    public static final int EXPECTED_STRUCTURES = 4;
    public static final int EXPECTED_DIMENSIONS = 1;
    public static final int EXPECTED_QUESTS = 5;
    public static final int EXPECTED_NPCS = 3;
