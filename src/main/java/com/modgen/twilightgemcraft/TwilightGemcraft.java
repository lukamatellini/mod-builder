...
import com.modgen.twilightgemcraft.ModItems;
import com.modgen.twilightgemcraft.ModBlocks;
import com.modgen.twilightgemcraft.entity.ModEntities;
import com.modgen.twilightgemcraft.ModStructures;

public class TwilightGemcraft implements ModInitializer {
    public static final String MOD_ID = "twilightgemcraft";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Twilight Gemcraft");
        ...
        LOGGER.info("Twilight Gemcraft initialized successfully!");
    }
}