package com.modgen.twilightgemcraft.structure;
...
public class AncientAetheriumShrineStructure {
    public static final int SIZE_X = 10;
    public static final int SIZE_Y = 8;
    public static final int SIZE_Z = 10;
    
    public static void register() {
        TwilightGemcraft.LOGGER.info("Registered structure: Ancient Aetherium Shrine");
    }
    ...
    public static void generate(World world, BlockPos origin) {
        TwilightGemcraft.LOGGER.info("Generating Ancient Aetherium Shrine at " + origin);
