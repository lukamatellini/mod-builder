package com.modgen.thunderrods.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("thunderrods", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("thunderrods", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("thunderrods", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("thunderrods", "dialogue_choice");
