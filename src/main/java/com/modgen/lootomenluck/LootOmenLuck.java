...
public class LootOmenLuck implements ModInitializer {
    public static final String MOD_ID = "lootomenluck";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Loot Omen Luck");
        ...
        LOGGER.info("Loot Omen Luck initialized successfully!");
    }
}