package com.modgen.trailblazeboots.engine;

import com.modgen.trailblazeboots.TrailblazeBoots;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("trailblazeboots/engine");
