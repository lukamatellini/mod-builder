 ...
 * 
 * JSON files are at: data/stormforgedsky/structures/{id}.json
 */
public class StructureRegistry {
    ...
    private static final Set<String> KNOWN_STRUCTURE_IDS = Set.of("sky_ruins");
    ...
    public int loadStructuresFromResources(MinecraftServer server) {
        ...
        for (String structureId : KNOWN_STRUCTURE_IDS) {
            try {
                ...
                var resourceId = Identifier.of("stormforgedsky", "structures/" + structureId + ".json");
