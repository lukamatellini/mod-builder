package com.modgen.stormforgedsky.engine;
...
public class BuildPlanValidator {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormforgedsky/validator");
    
    // Build Plan expectations (from build-plan.json)
    public static final String MINECRAFT_RANGE = ">=1.21 <1.22";
    public static final int EXPECTED_ITEMS = 3;
    ...
    public static final int EXPECTED_QUESTS = 1;
