...
public class QuestEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormforgedsky/quests");
    ...
    public int loadQuestsFromResources(MinecraftServer server) {
        ...
        try {
            ...
            for (var entry : questFiles.entrySet()) {
                ...
                if (!id.getNamespace().equals("stormforgedsky")) continue;
    ...
    private Path getSaveDirectory(MinecraftServer server) {
        return server.getSavePath(WorldSavePath.ROOT).resolve("stormforgedsky_quests");
    }
