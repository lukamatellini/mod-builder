...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        StormforgedSky.LOGGER.info("Registering blocks for " + StormforgedSky.MOD_ID);
        GLOWING_COBBLESTONE = registerBlock("glowing_cobblestone", 
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        if (GLOWING_COBBLESTONE != null) entries.add(GLOWING_COBBLESTONE.asItem());
    }
}