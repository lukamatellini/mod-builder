package com.modgen.romanlegions.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("romanlegions", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("romanlegions", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("romanlegions", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("romanlegions", "dialogue_choice");
