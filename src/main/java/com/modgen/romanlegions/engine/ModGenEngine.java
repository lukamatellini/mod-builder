...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("romanlegions/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (RomanLegions.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (RomanLegions.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}