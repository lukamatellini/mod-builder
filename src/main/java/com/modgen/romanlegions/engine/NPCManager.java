...
public class NPCManager {
    private static final Logger LOGGER = LoggerFactory.getLogger("romanlegions/npcs");
    ...
    private void registerNPCDefinitions() {
        npcDefinitions.put("enlistment_officer", new NPCDefinition(
            "enlistment_officer",
            "Enlistment Officer",
            "Legion Recruiter",
            "none"
        ));
        npcDefinitions.put("quartermaster", new NPCDefinition(
            "quartermaster",
            "Quartermaster",
