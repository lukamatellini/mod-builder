...
public class ModItems {
    ...
    public static void registerItems() {
        ...
        SWIFTSTRIDE_BOOTS = registerItem("swiftstride_boots", settings -> new ArmorItem(ModArmorMaterial.DIAMOND_EQUIVALENT, EquipmentType.BOOTS, settings), new Item.Settings().maxCount(1).maxDamage(200).rarity(Rarity.RARE));
    }
