...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormcaster/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (StormCaster.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (StormCaster.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}