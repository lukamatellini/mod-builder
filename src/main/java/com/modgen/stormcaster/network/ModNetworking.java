package com.modgen.stormcaster.network;

import com.modgen.stormcaster.StormCaster;
import com.modgen.stormcaster.client.screen.DialogueScreen;
import com.modgen.stormcaster.client.screen.QuestJournalScreen;
import com.modgen.stormcaster.engine.DialogueEngine;
...
public class ModNetworking {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("stormcaster", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("stormcaster", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("stormcaster", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("stormcaster", "dialogue_choice");
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(DialogueChoicePayload.ID, (payload, context) -> {
            context.server().execute(() -> {
                StormCaster.NPC_MANAGER.getDialogueEngine().selectChoice(context.player(), payload.choiceIndex);
            });
        });
    }
