package com.modgen.stormbinderwand.engine;

import com.modgen.stormbinderwand.StormbinderWand;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("stormbinderwand/engine");
