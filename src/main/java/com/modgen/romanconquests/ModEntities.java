...
import com.modgen.romanconquests.entity.RomanLegionaryEntity;
import com.modgen.romanconquests.entity.RomanCenturionEntity;
import com.modgen.romanconquests.entity.RomanEmperorBossEntity;


public class ModEntities {
    public static final EntityType<RomanLegionaryEntity> ROMAN_LEGIONARY = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(RomanConquests.MOD_ID, "roman_legionary"),
    ...
    public static final EntityType<RomanCenturionEntity> ROMAN_CENTURION = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(RomanConquests.MOD_ID, "roman_centurion"),
    ...
    public static final EntityType<RomanEmperorBossEntity> ROMAN_EMPEROR = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(RomanConquests.MOD_ID, "roman_emperor"),
    ...
    public static void registerEntities() {
        RomanConquests.LOGGER.info("Registering entities for " + RomanConquests.MOD_ID);
