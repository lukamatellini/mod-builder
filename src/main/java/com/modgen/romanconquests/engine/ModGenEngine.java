...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("romanconquests/engine");
    ...
    public void debug() {
        ...
        LOGGER.info("Quest Engine: " + (RomanConquests.QUEST_ENGINE != null ? "OK" : "NULL"));
        LOGGER.info("NPC Manager: " + (RomanConquests.NPC_MANAGER != null ? "OK" : "NULL"));
    }
}