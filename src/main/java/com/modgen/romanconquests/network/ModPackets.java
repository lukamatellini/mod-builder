package com.modgen.romanconquests.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("romanconquests", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("romanconquests", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("romanconquests", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("romanconquests", "dialogue_choice");
