...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        SumoUndeadWorms.LOGGER.info("Registering blocks for " + SumoUndeadWorms.MOD_ID);
        TATAMI_MAT = registerBlock("tatami_mat", 
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        if (TATAMI_MAT != null) entries.add(TATAMI_MAT.asItem());
    }
}