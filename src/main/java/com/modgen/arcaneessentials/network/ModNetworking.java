...
import com.modgen.arcaneessentials.engine.DialogueEngine;
    ...
    public static void registerServerPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(ModPackets.DialogueChoicePayload.ID, (payload, context) -> {
            ...
            player.getServer().execute(() -> {
                ArcaneEssentials.NPC_MANAGER.getDialogueEngine().selectChoice(player, payload.choiceIndex());
            });
        });
        
        ArcaneEssentials.LOGGER.info("Registered server networking");
    }
