package com.modgen.arcaneessentials.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("arcaneessentials", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("arcaneessentials", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("arcaneessentials", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("arcaneessentials", "dialogue_choice");
