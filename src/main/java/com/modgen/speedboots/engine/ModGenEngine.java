package com.modgen.speedboots.engine;

import com.modgen.speedboots.SpeedBoots;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("speedboots/engine");
