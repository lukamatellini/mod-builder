package com.modgen.skyboltwand.engine;

import com.modgen.skyboltwand.SkyboltWand;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("skyboltwand/engine");
