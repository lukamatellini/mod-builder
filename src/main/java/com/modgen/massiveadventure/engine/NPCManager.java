...
public class NPCManager {
    private static final Logger LOGGER = LoggerFactory.getLogger("massiveadventure/npcs");
    ...
    private void registerNPCDefinitions() {
        npcDefinitions.put("void_oracle", new NPCDefinition(
            "void_oracle",
            "The Void Oracle",
            "Mystic Elder",
            "none"
        ));
        npcDefinitions.put("wandering_scholar", new NPCDefinition(
            "wandering_scholar",
            "Wandering Scholar",
            "Librarian",
            "none"
        ));
        npcDefinitions.put("village_elder", new NPCDefinition(
            "village_elder",
            "Village Elder",
            "Armorer",
            "none"
