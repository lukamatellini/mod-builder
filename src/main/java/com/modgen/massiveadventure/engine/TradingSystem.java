package com.modgen.massiveadventure.engine;
...
public class TradingSystem {
    private static final Logger LOGGER = LoggerFactory.getLogger("massiveadventure/trading");
    ...
    private void registerTrades() {
            addTrade("void_oracle", new TradeOffer(
                "minecraft:void_essence", 1,
                null, 0,
                "5", 1,
                10, 2, 0
            ));
    ...
    public List<TradeOffer> getAvailableTradesForPlayer(ServerPlayerEntity player, String npcId) {
        ...
        int playerRep = MassiveAdventure.REPUTATION_SYSTEM.getReputation(player.getUuid(), npcId);
    ...
    public TradeResult executeTrade(ServerPlayerEntity player, String npcId, int tradeIndex) {
        ...
        MassiveAdventure.REPUTATION_SYSTEM.modifyReputation(player.getUuid(), npcId, 1);
    ...
    private Item resolveItem(String itemId) {
        try {
            Identifier id = itemId.contains(":") ? Identifier.of(itemId) : Identifier.of("massiveadventure", itemId);
