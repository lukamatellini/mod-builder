package com.modgen.massiveadventure.network;
...
public class ModPackets {
    ...
    // Packet IDs
    public static final Identifier OPEN_JOURNAL_ID = Identifier.of("massiveadventure", "open_journal");
    public static final Identifier DIALOGUE_ID = Identifier.of("massiveadventure", "dialogue");
    public static final Identifier CLOSE_DIALOGUE_ID = Identifier.of("massiveadventure", "close_dialogue");
    public static final Identifier DIALOGUE_CHOICE_ID = Identifier.of("massiveadventure", "dialogue_choice");
    public static final Identifier OPEN_TRADING_ID = Identifier.of("massiveadventure", "open_trading");
    public static final Identifier EXECUTE_TRADE_ID = Identifier.of("massiveadventure", "execute_trade");
    public static final Identifier PROGRESS_BAR_UPDATE_ID = Identifier.of("massiveadventure", "progress_bar_update");
