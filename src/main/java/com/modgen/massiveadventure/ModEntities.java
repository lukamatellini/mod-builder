...
import com.modgen.massiveadventure.entity.VoidWispEntity;
import com.modgen.massiveadventure.entity.CrystalGolemEntity;
...
public class ModEntities {
    public static final EntityType<VoidWispEntity> VOID_WISP = Registry.register(
        ...
        Identifier.of(MassiveAdventure.MOD_ID, "void_wisp"),
    ...
    public static final EntityType<CrystalGolemEntity> CRYSTAL_GOLEM = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(MassiveAdventure.MOD_ID, "crystal_golem"),
    ...
    public static final EntityType<CrystalGuardianEntity> CRYSTAL_GUARDIAN = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(MassiveAdventure.MOD_ID, "crystal_guardian"),
    ...
    public static final EntityType<VoidOverlordBossEntity> VOID_OVERLORD = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(MassiveAdventure.MOD_ID, "void_overlord"),
    ...
    public static final EntityType<ModGenNPCEntity> NPC_ENTITY_TYPE = Registry.register(
        Registries.ENTITY_TYPE,
        Identifier.of(MassiveAdventure.MOD_ID, "npc"),
    ...
    public static void registerEntities() {
        MassiveAdventure.LOGGER.info("Registering entities for " + MassiveAdventure.MOD_ID);
        ...
        MassiveAdventure.LOGGER.info("Registering natural spawn rules for 3 mobs");
