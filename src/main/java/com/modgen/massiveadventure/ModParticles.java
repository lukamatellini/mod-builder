...
public class ModParticles {
    ...
    public static void register() {
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(MassiveAdventure.MOD_ID, "magic"), MAGIC);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(MassiveAdventure.MOD_ID, "flame"), FLAME);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(MassiveAdventure.MOD_ID, "soul"), SOUL);
        Registry.register(Registries.PARTICLE_TYPE, Identifier.of(MassiveAdventure.MOD_ID, "void"), VOID);
    }
}