package com.modgen.massiveadventure.item;
...
/**
 * Warp Item for The Ethereal Void dimension
 * Right-click to teleport to/from the dimension
 */
public class EtherealVoidWarpItem extends Item {
    
    private static final RegistryKey<World> DIMENSION_KEY = RegistryKey.of(
        RegistryKeys.WORLD, Identifier.of(MassiveAdventure.MOD_ID, "ethereal_void")
    );
    
    public EtherealVoidWarpItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient && player instanceof ServerPlayerEntity serverPlayer) {
            ...
            if (world.getRegistryKey().equals(DIMENSION_KEY)) {
                ...
                player.sendMessage(Text.literal("§dTeleporting to The Ethereal Void..."), true);
            }
