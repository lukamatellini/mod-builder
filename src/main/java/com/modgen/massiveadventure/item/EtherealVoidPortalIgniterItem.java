...
public class EtherealVoidPortalIgniterItem extends Item {
    
    public EtherealVoidPortalIgniterItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            // Generic action
            player.sendMessage(Text.literal("§aUsed The Ethereal Void Portal Key!"), true);
        }
