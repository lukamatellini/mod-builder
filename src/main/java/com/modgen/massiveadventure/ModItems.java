...
import com.modgen.massiveadventure.item.VoidScepterItem;
import com.modgen.massiveadventure.item.VoidEssenceItem;
import com.modgen.massiveadventure.item.EtherealVoidPortalIgniterItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        Identifier id = Identifier.of(MassiveAdventure.MOD_ID, name);
    ...
    public static void registerItems() {
        MassiveAdventure.LOGGER.info("Registering items for " + MassiveAdventure.MOD_ID);
        ...
        CRYSTAL_HELMET = registerItem("crystal_helmet", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.HELMET, settings), new Item.Settings().maxCount(1).maxDamage(300).rarity(Rarity.RARE));
        CRYSTAL_CHESTPLATE = registerItem("crystal_chestplate", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.CHESTPLATE, settings), new Item.Settings().maxCount(1).maxDamage(400).rarity(Rarity.RARE));
        CRYSTAL_LEGGINGS = registerItem("crystal_leggings", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.LEGGINGS, settings), new Item.Settings().maxCount(1).maxDamage(350).rarity(Rarity.RARE));
        CRYSTAL_BOOTS = registerItem("crystal_boots", settings -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorItem.Type.BOOTS, settings), new Item.Settings().maxCount(1).maxDamage(250).rarity(Rarity.RARE));
