...
public class AncientDragonBossEntity extends HostileEntity {
    private int abilityCooldown = 0;
    
    public AncientDragonBossEntity(EntityType<? extends AncientDragonBossEntity> entityType, World world) {
