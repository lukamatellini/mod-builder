...
import com.modgen.dragonsheir.structure.DragonLairStructure;
import com.modgen.dragonsheir.structure.CrystalCaveStructure;
import com.modgen.dragonsheir.structure.PirateShipStructure;
import com.modgen.dragonsheir.structure.WizardTowerStructure;

public class ModStructures {
    private static final Logger LOGGER = LoggerFactory.getLogger("dragonsheir/structures");
    
    public static void registerStructures() {
        DragonsHeir.LOGGER.info("Registering 4 structures for worldgen");
        
        // Register worldgen for: Dragon's Lair
