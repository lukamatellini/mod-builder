...
public class LuckyBreaks implements ModInitializer {
    public static final String MOD_ID = "luckybreaks";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Lucky Breaks");
        ...
        LOGGER.info("Lucky Breaks initialized successfully!");
    }
}