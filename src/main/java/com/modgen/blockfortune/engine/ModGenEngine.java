package com.modgen.blockfortune.engine;

import com.modgen.blockfortune.BlockFortune;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("blockfortune/engine");
