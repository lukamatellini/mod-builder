...
import com.modgen.luckyblocks.engine.StructureRegistry;
...
public class ModStructures {
    ...
    public static void registerStructures() {
        LuckyBlocks.LOGGER.info("Registering 1 structures for worldgen");
        
        // Register worldgen for: Small Stone Building
        registerStructureFeature("small_stone_building", BiomeSelectors.tag(BiomeTags.IS_FOREST), 500);
