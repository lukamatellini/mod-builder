 ...
 */
public class AbyssalVoidWarpItem extends Item {
    
    private static final RegistryKey<World> DIMENSION_KEY = RegistryKey.of(
        RegistryKeys.WORLD, Identifier.of(AbyssAwakensIsAnEpicAdventure.MOD_ID, "abyssal_void")
    );
    
    public AbyssalVoidWarpItem(Settings settings) {
        super(settings);
    }
