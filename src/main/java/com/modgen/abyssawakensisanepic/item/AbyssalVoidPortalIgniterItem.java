package com.modgen.abyssawakensisanepic.item;
...
public class AbyssalVoidPortalIgniterItem extends Item {
    
    public AbyssalVoidPortalIgniterItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {
            // Generic action
            player.sendMessage(Text.literal("§aUsed The Abyssal Void Portal Key!"), true);
        }
