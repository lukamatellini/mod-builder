...
public class BuildPlanValidator {
    private static final Logger LOGGER = LoggerFactory.getLogger("abyssawakensisanepic/validator");
    
    // Build Plan expectations (from build-plan.json)
    public static final String MINECRAFT_RANGE = ">=1.21 <1.22";
    public static final int EXPECTED_ITEMS = 13;
    public static final int EXPECTED_MOBS = 7;
    public static final int EXPECTED_STRUCTURES = 7;
    public static final int EXPECTED_DIMENSIONS = 1;
    public static final int EXPECTED_QUESTS = 4;
    public static final int EXPECTED_NPCS = 4;
    public static final int EXPECTED_EVENTS = 2;
    
    // Module flags
    public static final boolean MODULE_QUESTS = true;
    public static final boolean MODULE_NPCS = true;
    public static final boolean MODULE_DIALOGUE = true;
    public static final boolean MODULE_TRADING = true;
    public static final boolean MODULE_STRUCTURES = true;
    public static final boolean MODULE_DIMENSIONS = true;
    public static final boolean MODULE_BIOMES = true;
    public static final boolean MODULE_ITEMS = true;
    public static final boolean MODULE_MOBS = true;
    public static final boolean MODULE_EVENTS = true;
