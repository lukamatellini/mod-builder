package com.modgen.abyssawakensisanepic.engine;
...
public class TradingSystem {
    private static final Logger LOGGER = LoggerFactory.getLogger("abyssawakensisanepic/trading");
    ...
    private void registerTrades() {
            addTrade("elder_sage", new TradeOffer(
                "minecraft:void_silk", 1,
                null, 0,
                "1", 1,
                10, 2, 0
            ));
            addTrade("wandering_alchemist", new TradeOffer(
                "minecraft:crystal_shard", 8,
                null, 0,
                "1", 1,
                10, 2, 0
            ));
    ...
    public List<TradeOffer> getAvailableTradesForPlayer(ServerPlayerEntity player, String npcId) {
        ...
        int playerRep = AbyssAwakensIsAnEpicAdventure.REPUTATION_SYSTEM.getReputation(player.getUuid(), npcId);
    ...
    public TradeResult executeTrade(ServerPlayerEntity player, String npcId, int tradeIndex) {
        ...
        AbyssAwakensIsAnEpicAdventure.REPUTATION_SYSTEM.modifyReputation(player.getUuid(), npcId, 1);
    ...
    private Item resolveItem(String itemId) {
        try {
            Identifier id = itemId.contains(":") ? Identifier.of(itemId) : Identifier.of("abyssawakensisanepic", itemId);
