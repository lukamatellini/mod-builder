package com.modgen.abyssawakensisanepic.entity;
...
public class CorruptedVillagerEntity extends HostileEntity {
    // No ability cooldowns
    
    public CorruptedVillagerEntity(EntityType<? extends CorruptedVillagerEntity> entityType, World world) {
