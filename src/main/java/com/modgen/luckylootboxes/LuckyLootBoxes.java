...
import com.modgen.luckylootboxes.ModItems;
import com.modgen.luckylootboxes.ModBlocks;
...
public class LuckyLootBoxes implements ModInitializer {
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Lucky Loot Boxes");
        ...
        LOGGER.info("Lucky Loot Boxes initialized successfully!");
    }
}