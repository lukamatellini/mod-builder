...
public class ModBlocks {
    ...
    public static Block CURSED_LUCKY_BLOCK;
    ...
    public static void registerBlocks() {
        LuckyLootBoxes.LOGGER.info("Registering blocks for " + LuckyLootBoxes.MOD_ID);
        ...
        CURSED_LUCKY_BLOCK = registerBlock("cursed_lucky_block", 
            settings -> new Block(settings), 
            AbstractBlock.Settings.create()
            .hardness(3f)
            .resistance(6f)
    ...
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        ...
        if (CURSED_LUCKY_BLOCK != null) entries.add(CURSED_LUCKY_BLOCK.asItem());
    }
}