...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        NavalArchitect.LOGGER.info("Registering blocks for " + NavalArchitect.MOD_ID);
        SHIP_CORE = registerBlock("ship_core", 
    ...
    public static Item getFirstBlockItem() {
        return SHIP_CORE.asItem();
    }
    
    public static void addToCreativeTab(ItemGroup.Entries entries) {
        if (SHIP_CORE != null) entries.add(SHIP_CORE.asItem());
    }
}