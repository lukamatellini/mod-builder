...
public class FortunesGamble implements ModInitializer {
    public static final String MOD_ID = "fortunesgamble";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Fortunes Gamble");
        ...
        LOGGER.info("Fortunes Gamble initialized successfully!");
    }
}