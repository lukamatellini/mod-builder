...
import com.modgen.aetherfellarmory.ModItems;
import com.modgen.aetherfellarmory.ModBlocks;
import com.modgen.aetherfellarmory.entity.ModEntities;
import com.modgen.aetherfellarmory.ModDimensions;

public class AetherfellArmory implements ModInitializer {
    public static final String MOD_ID = "aetherfellarmory";
    ...
    public void onInitialize() {
        LOGGER.info("Initializing Aetherfell Armory");
        ...
        LOGGER.info("Aetherfell Armory initialized successfully!");
    }
}