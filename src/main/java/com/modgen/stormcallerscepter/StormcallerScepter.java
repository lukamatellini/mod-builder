package com.modgen.stormcallerscepter;

import com.modgen.stormcallerscepter.engine.ModGenEngine;
import com.modgen.stormcallerscepter.engine.BuildPlanValidator;
...
public class StormcallerScepter implements ModInitializer {
    public static final String MOD_ID = "stormcallerscepter";
    ...
    public void onInitialize() {
        LOGGER.info("╔════════════════════════════════════════╗");
        LOGGER.info("║  Stormcaller Scepter                   ║");
        ...
        LOGGER.info("Stormcaller Scepter initialized successfully!");
    }
}