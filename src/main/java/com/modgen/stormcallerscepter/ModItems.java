...
import com.modgen.stormcallerscepter.item.LightningWandItem;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
        Identifier id = Identifier.of(StormcallerScepter.MOD_ID, name);
    ...
    public static void registerItems() {
        StormcallerScepter.LOGGER.info("Registering items for " + StormcallerScepter.MOD_ID);
