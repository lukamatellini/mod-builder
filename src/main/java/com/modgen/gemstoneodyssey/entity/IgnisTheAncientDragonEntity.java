...
public class IgnisTheAncientDragonEntity extends HostileEntity {
    private int abilityCooldown = 0;
    
    public IgnisTheAncientDragonEntity(EntityType<? extends IgnisTheAncientDragonEntity> entityType, World world) {
