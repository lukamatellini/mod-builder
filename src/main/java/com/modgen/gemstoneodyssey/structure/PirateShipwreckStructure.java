...
public class PirateShipwreckStructure {
    public static final int SIZE_X = 10;
    public static final int SIZE_Y = 8;
    public static final int SIZE_Z = 10;
    
    public static void register() {
        GemstoneOdyssey.LOGGER.info("Registered structure: Pirate Shipwreck");
    }
    ...
    public static void generate(World world, BlockPos origin) {
        GemstoneOdyssey.LOGGER.info("Generating Pirate Shipwreck at " + origin);
