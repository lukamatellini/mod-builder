package com.modgen.blockyfortune.engine;

import com.modgen.blockyfortune.BlockyFortune;
...
public class ModGenEngine {
    private static final Logger LOGGER = LoggerFactory.getLogger("blockyfortune/engine");
