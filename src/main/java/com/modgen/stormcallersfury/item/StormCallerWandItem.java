package com.modgen.stormcallersfury.item;

import com.modgen.stormcallersfury.StormcallersFury;
...
public class StormCallerWandItem extends Item {
    
    public StormCallerWandItem(Settings settings) {
        super(settings);
    }
